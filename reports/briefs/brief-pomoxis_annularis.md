# Drafting brief — White crappie

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Pomoxis annularis*
Proposed species id: `pomoxis_annularis`
Queued under: B - crappie

Why it was asked for: The other half of the merged crappie record.
...
- **White sturgeon** `acipenser_transmontanus` (*Acipenser transmontanus*) — shares the word "white"
- **White catfish** `ameiurus_catus` (*Ameiurus catus*) — shares the word "white"
- **White seabass** `atractoscion_nobilis` (*Atractoscion nobilis*) — shares the word "white"
- **White sucker** `catostomus_commersonii` (*Catostomus commersonii*) — shares the word "white"
- **White perch** `morone_americana` (*Morone americana*) — shares the word "white"
- **White bass** `morone_chrysops` (*Morone chrysops*) — shares the word "white"
