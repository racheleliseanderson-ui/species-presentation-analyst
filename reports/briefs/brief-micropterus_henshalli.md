# Drafting brief — Alabama bass

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Micropterus henshalli*
Proposed species id: `micropterus_henshalli`
Queued under: A - the black bass complex, which is three records deep and needs to be seven

Why it was asked for: Split out of spotted bass and now stocked and spreading well outside its native range, where it hybridises with and displaces smallmouth bass. Anglers call it a spotted bass and several states no longer agree. This is the hardest black bass identification in the country and it carries a limit.
...
- **Smallmouth bass** `micropterus_dolomieu` (*Micropterus dolomieu*) — you named it in the note, same genus, also a "bass"
- **Spotted bass** `micropterus_punctulatus` (*Micropterus punctulatus*) — you named it in the note, same genus, also a "bass"
- **Largemouth bass** `micropterus_nigricans` (*Micropterus nigricans*) — same genus, also a "bass"
...
- **Rock bass** `ambloplites_rupestris` (*Ambloplites rupestris*) — also a "bass"
- **Black sea bass** `centropristis_striata` (*Centropristis striata*) — also a "bass"
- **White bass** `morone_chrysops` (*Morone chrysops*) — also a "bass"
- **Hybrid striped bass** `morone_hybrid_wiper` (*Morone chrysops × Morone saxatilis*) — also a "bass"
- **Yellow bass** `morone_mississippiensis` (*Morone mississippiensis*) — also a "bass"
- **Striped bass** `morone_saxatilis` (*Morone saxatilis*) — also a "bass"
- **Red drum** `sciaenops_ocellatus` (*Sciaenops ocellatus*) — also a "bass"
