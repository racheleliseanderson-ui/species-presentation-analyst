...
Scientific name as given: *Scomberomorus regalis*
Proposed species id: `scomberomorus_regalis`
Queued under: F - tuna and mackerel

Why it was asked for: Spanish and king mackerel are both in. Cero sits between them, is separated by the lateral stripe and spotting, and carries its own limit.
...
- **King mackerel** `scomberomorus_cavalla` (*Scomberomorus cavalla*) — you named it in the note, same genus
- **Spanish mackerel** `scomberomorus_maculatus` (*Scomberomorus maculatus*) — same genus
