# Drafting brief — Bull shark

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Carcharhinus leucas*
Proposed species id: `carcharhinus_leucas`
Queued under: J - sharks

Why it was asked for: Enters fresh water, so it collides with records in this catalogue that no other shark does, and it is the third corner of the sandbar and dusky confusion.
...
- **Bull trout** `salvelinus_confluentus` (*Salvelinus confluentus*) — shares the word "bull"
