# Drafting brief — Florida pompano

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Trachinotus carolinus*
Proposed species id: `trachinotus_carolinus`
Queued under: D - inshore

Why it was asked for: Permit is already in the catalogue and pompano is the fish people actually catch from the beach. They are the same genus, they are separated by body depth and dorsal lobe, and they carry different limits. Leaving pompano out while permit is in is the wrong way round.
...
- **Permit** `trachinotus_falcatus` (*Trachinotus falcatus*) — you named it in the note, same genus
