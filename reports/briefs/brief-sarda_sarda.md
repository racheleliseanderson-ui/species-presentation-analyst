# Drafting brief — Atlantic bonito

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Sarda sarda*
Proposed species id: `sarda_sarda`
Queued under: F - tuna and mackerel

Why it was asked for: The other half of the false albacore confusion, and the one that is actually good to eat, which is why people care which they have.
