# Drafting brief — Yelloweye rockfish

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Sebastes ruberrimus*
Proposed species id: `sebastes_ruberrimus`
Queued under: G - Pacific

Why it was asked for: Rebuilding stock, prohibited or severely restricted in much of its range, and confused with vermilion rockfish, which is already in the catalogue. This is a conservation-sensitive or regulated-context record before it is a fishing one.
...
- **Vermilion rockfish** `sebastes_miniatus` (*Sebastes miniatus*) — you named it in the note, same genus, also a "rockfish"
