# Drafting brief — Florida bass

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Micropterus salmoides*
Proposed species id: `micropterus_salmoides`
Queued under: A - black bass

Why it was asked for: The largemouth bass record here uses Micropterus nigricans, which follows the recent revision. Which name attaches to which fish changed recently and the sources disagree; resolving that against a current authority is part of this record, not an assumption to carry into it.
...
- **Largemouth bass** `micropterus_nigricans` (*Micropterus nigricans*) — you named it in the note, same genus, also a "bass"
- **Smallmouth bass** `micropterus_dolomieu` (*Micropterus dolomieu*) — same genus, also a "bass"
- **Spotted bass** `micropterus_punctulatus` (*Micropterus punctulatus*) — same genus, also a "bass"
