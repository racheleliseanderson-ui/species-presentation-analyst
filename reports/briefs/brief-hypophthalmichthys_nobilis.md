# Drafting brief — Bighead carp

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Hypophthalmichthys nobilis*
Proposed species id: `hypophthalmichthys_nobilis`
Queued under: C - invasive carp

Why it was asked for: Separated from silver carp only by eye position and mottling. Both are filter feeders like the paddlefish record, so the same fail-closed logic may apply.
...
- **Paddlefish** `polyodon_spathula` (*Polyodon spathula*) — you named it in the note
