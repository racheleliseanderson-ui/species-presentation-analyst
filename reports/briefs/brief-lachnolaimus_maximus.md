# Drafting brief — Hogfish

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Lachnolaimus maximus*
Proposed species id: `lachnolaimus_maximus`
Queued under: E - snapper and grouper

Why it was asked for: California sheephead is in the catalogue; the Atlantic wrasse that everyone calls hogfish is not, and the two share the sheephead alias.
...
- **California sheephead** `bodianus_pulcher` (*Bodianus pulcher*) — you named it in the note
