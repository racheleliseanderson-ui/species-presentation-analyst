...
Why it was asked for: Greater amberjack is in the catalogue; the Pacific Seriola that the entire southern California fishery runs on is not.
...
- **Greater amberjack** `seriola_dumerili` (*Seriola dumerili*) — you named it in the note, same genus
