# Drafting brief — Crevalle jack

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Caranx hippos*
Proposed species id: `caranx_hippos`
Queued under: D - inshore

Why it was asked for: Caught constantly by people fishing for snook and red drum, and reported as everything from a permit to a bluefish.
...
- **Common snook** `centropomus_undecimalis` (*Centropomus undecimalis*) — you named it in the note
- **Black drum** `pogonias_cromis` (*Pogonias cromis*) — you named it in the note
- **Bluefish** `pomatomus_saltatrix` (*Pomatomus saltatrix*) — you named it in the note
- **Red drum** `sciaenops_ocellatus` (*Sciaenops ocellatus*) — you named it in the note
- **Permit** `trachinotus_falcatus` (*Trachinotus falcatus*) — you named it in the note
