# Drafting brief — California halibut

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Paralichthys californicus*
Proposed species id: `paralichthys_californicus`
Queued under: G - Pacific

Why it was asked for: Same genus as the summer flounder record, entirely different fishery from the Pacific halibut record already written, and confused with both.
...
- **Pacific halibut** `hippoglossus_stenolepis` (*Hippoglossus stenolepis*) — you named it in the note, also a "halibut"
- **Summer flounder** `paralichthys_dentatus` (*Paralichthys dentatus*) — you named it in the note, same genus
