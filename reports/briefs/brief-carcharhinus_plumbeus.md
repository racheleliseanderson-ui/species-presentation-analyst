# Drafting brief — Sandbar shark

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Carcharhinus plumbeus*
Proposed species id: `carcharhinus_plumbeus`
Queued under: J - sharks, on the same argument the catalogue already makes for blacktip and spinner

Why it was asked for: Prohibited in the recreational fishery and confused with dusky and bull shark. The catalogue already separates blacktip from spinner for exactly this reason.
...
- **Spinner shark** `carcharhinus_brevipinna` (*Carcharhinus brevipinna*) — same genus, also a "shark"
- **Blacktip shark** `carcharhinus_limbatus` (*Carcharhinus limbatus*) — same genus, also a "shark"
...
- **Atlantic sharpnose shark** `rhizoprionodon_terraenovae` (*Rhizoprionodon terraenovae*) — also a "shark"
- **Bonnethead** `sphyrna_tiburo` (*Sphyrna tiburo*) — also a "shark"
