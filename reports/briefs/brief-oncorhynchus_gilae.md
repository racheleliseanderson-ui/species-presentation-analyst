# Drafting brief — Gila trout

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Oncorhynchus gilae*
Proposed species id: `oncorhynchus_gilae`
Queued under: I - western native trout

Why it was asked for: Threatened, limited catch-and-release fisheries only, and separated from Apache trout by fine spotting. Conservation-sensitive until a source says otherwise.
...
- **Rainbow trout** `oncorhynchus_mykiss` (*Oncorhynchus mykiss*) — same genus, also a "trout"
