...
Why it was asked for: Same genus as the yellowfin record. Taken for a small yellowfin constantly.
...
- **Yellowfin tuna** `thunnus_albacares` (*Thunnus albacares*) — same genus, also a "tuna"
