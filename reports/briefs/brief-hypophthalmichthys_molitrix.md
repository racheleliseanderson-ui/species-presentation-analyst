# Drafting brief — Silver carp

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Hypophthalmichthys molitrix*
Proposed species id: `hypophthalmichthys_molitrix`
Queued under: C - invasive carp

Why it was asked for: Confused with bigmouth buffalo, which is already in the catalogue as a regulated-context record, and with gizzard shad at small size. Jumping behaviour makes it the one every angler has heard of and few can identify.
...
- **Bigmouth buffalo** `ictiobus_cyprinellus` (*Ictiobus cyprinellus*) — you named it in the note
...
- **Tarpon** `megalops_atlanticus` (*Megalops atlanticus*) — shares the word "silver"
