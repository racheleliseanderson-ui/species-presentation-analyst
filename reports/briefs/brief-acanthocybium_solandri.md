# Drafting brief — Wahoo

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Acanthocybium solandri*
Proposed species id: `acanthocybium_solandri`
Queued under: F - tuna and mackerel

Why it was asked for: Fished on the same offshore features as the mahi and king mackerel records and mistaken for a king mackerel by people who have never seen one.
...
- **King mackerel** `scomberomorus_cavalla` (*Scomberomorus cavalla*) — you named it in the note
