# Drafting brief — Cabezon

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Scorpaenichthys marmoratus*
Proposed species id: `scorpaenichthys_marmoratus`
Queued under: G - Pacific

Why it was asked for: Caught alongside lingcod, which is written, and taken for one. Its roe is toxic, which is a safety fact rather than a preference.
...
- **Lingcod** `ophiodon_elongatus` (*Ophiodon elongatus*) — you named it in the note
