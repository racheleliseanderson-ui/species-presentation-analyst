# Drafting brief — Black crappie

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Pomoxis nigromaculatus*
Proposed species id: `pomoxis_nigromaculatus`
Queued under: B - the crappie record is currently two fish in one

Why it was asked for: The catalogue carries a single merged crappie record covering both Pomoxis species. Black and white crappie have different limits in a number of states and separating them by dorsal spine count and barring is the most-asked panfish identification in fresh water. Splitting the record may be the right answer, or keeping it merged and saying why may be; either way it should be a decision rather than an inheritance.
...
- **Crappie** `pomoxis_spp` (*Pomoxis nigromaculatus / P. annularis*) — you named it in the note, same genus, also a "crappie"
...
- **Black bullhead** `ameiurus_melas` (*Ameiurus melas*) — shares the word "black"
- **Black sea bass** `centropristis_striata` (*Centropristis striata*) — shares the word "black"
- **Black drum** `pogonias_cromis` (*Pogonias cromis*) — shares the word "black"
