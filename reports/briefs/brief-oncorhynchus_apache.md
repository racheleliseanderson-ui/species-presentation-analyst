# Drafting brief — Apache trout

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Oncorhynchus apache*
Proposed species id: `oncorhynchus_apache`
Queued under: I - western native trout, all of which read as a rainbow to most people

Why it was asked for: Federally recovered but still tightly managed, hybridises with rainbow trout, and confused with golden trout and cutthroat. Likely regulated context.
...
- **Brook trout** `salvelinus_fontinalis` (*Salvelinus fontinalis*) — also a "trout"
