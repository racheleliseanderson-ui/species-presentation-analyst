# Drafting brief — Little tunny

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Euthynnus alletteratus*
Proposed species id: `euthynnus_alletteratus`
Queued under: F - the tuna and mackerel confusion set

Why it was asked for: Called false albacore and bonito interchangeably, and confused with Atlantic bonito, skipjack and small blackfin tuna. Nothing in this group is currently in the catalogue except yellowfin.

## What it will be confused with

Nothing in the catalogue shares its genus or its common name. Worth a second look rather than a relief — a fish with no lookalike in a 111-record North American catalogue is either genuinely distinct or the scientific name is wrong.
