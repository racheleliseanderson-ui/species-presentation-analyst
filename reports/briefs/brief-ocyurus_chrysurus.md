# Drafting brief — Yellowtail snapper

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Ocyurus chrysurus*
Proposed species id: `ocyurus_chrysurus`
Queued under: E - snapper and grouper

Why it was asked for: Different feeding position in the water column from every snapper currently in the catalogue, which changes the presentation answer, not just the identification.
...
- **Mutton snapper** `lutjanus_analis` (*Lutjanus analis*) — also a "snapper"
- **Red snapper** `lutjanus_campechanus` (*Lutjanus campechanus*) — also a "snapper"
