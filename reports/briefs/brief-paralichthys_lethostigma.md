# Drafting brief — Southern flounder

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Paralichthys lethostigma*
Proposed species id: `paralichthys_lethostigma`
Queued under: D - inshore

Why it was asked for: Summer flounder is in; southern and gulf flounder are not. The three overlap, the eyed-side spotting is the separation, and states set different seasons for them.
...
- **Summer flounder** `paralichthys_dentatus` (*Paralichthys dentatus*) — you named it in the note, same genus, also a "flounder"
