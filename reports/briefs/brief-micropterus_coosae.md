# Drafting brief — Redeye bass

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Micropterus coosae*
Proposed species id: `micropterus_coosae`
Queued under: A - black bass

Why it was asked for: Confused with rock bass, which already carries the redeye and red eye aliases in this catalogue, and with shoal bass. The alias collision alone is a reason to write the record.
...
- **Rock bass** `ambloplites_rupestris` (*Ambloplites rupestris*) — you named it in the note, also a "bass"
