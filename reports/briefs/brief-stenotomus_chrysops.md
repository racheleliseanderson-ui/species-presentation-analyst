...
Scientific name as given: *Stenotomus chrysops*
Proposed species id: `stenotomus_chrysops`
Queued under: H - Northeast

Why it was asked for: Same family as the sheepshead record and the porgy every Northeast bottom angler catches.
...
- **Sheepshead** `archosargus_probatocephalus` (*Archosargus probatocephalus*) — you named it in the note
