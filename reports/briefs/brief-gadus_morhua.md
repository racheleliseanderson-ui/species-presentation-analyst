# Drafting brief — Atlantic cod

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Gadus morhua*
Proposed species id: `gadus_morhua`
Queued under: H - Northeast bottom and structure

Why it was asked for: Nothing in the catalogue covers the New England groundfish bottom fishery, and cod is confused with pollock and haddock, all three under different rules.
