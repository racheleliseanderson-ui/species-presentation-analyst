# Drafting brief — Winter flounder

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Pseudopleuronectes americanus*
Proposed species id: `pseudopleuronectes_americanus`
Queued under: H - Northeast

Why it was asked for: Right-eyed against the summer flounder record's left-eyed, which is the cleanest separation in the whole flatfish group and worth writing down once properly.
...
- **Summer flounder** `paralichthys_dentatus` (*Paralichthys dentatus*) — you named it in the note, also a "flounder"
