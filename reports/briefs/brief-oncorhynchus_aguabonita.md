# Drafting brief — California golden trout

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Oncorhynchus aguabonita*
Proposed species id: `oncorhynchus_aguabonita`
Queued under: I - western native trout

Why it was asked for: California state fish, high-elevation only, and taken for a rainbow trout or a small brook trout by anyone who has not seen one.
...
- **Rainbow trout** `oncorhynchus_mykiss` (*Oncorhynchus mykiss*) — you named it in the note, same genus, also a "trout"
- **Brook trout** `salvelinus_fontinalis` (*Salvelinus fontinalis*) — you named it in the note, also a "trout"
- **Cutthroat trout** `oncorhynchus_clarkii` (*Oncorhynchus clarkii*) — same genus, also a "trout"
- **Pink salmon** `oncorhynchus_gorbuscha` (*Oncorhynchus gorbuscha*) — same genus
- **Chum salmon** `oncorhynchus_keta` (*Oncorhynchus keta*) — same genus
- **Coho salmon** `oncorhynchus_kisutch` (*Oncorhynchus kisutch*) — same genus
- **Steelhead** `oncorhynchus_mykiss_steelhead` (*Oncorhynchus mykiss (anadromous)*) — same genus
- **Sockeye salmon** `oncorhynchus_nerka_anadromous` (*Oncorhynchus nerka*) — same genus
- **Kokanee** `oncorhynchus_nerka_kokanee` (*Oncorhynchus nerka (landlocked)*) — same genus
- **Chinook salmon** `oncorhynchus_tshawytscha` (*Oncorhynchus tshawytscha*) — same genus

### Share a word, probably not a confusion

Listed only so the alias table can be checked. A record here should not carry an informal name that already resolves to one of these.

- **Spotted seatrout** `cynoscion_nebulosus` (*Cynoscion nebulosus*) — also a "trout"
- **Brown trout** `salmo_trutta` (*Salmo trutta*) — also a "trout"
- **Bull trout** `salvelinus_confluentus` (*Salvelinus confluentus*) — also a "trout"
- **Lake trout** `salvelinus_namaycush` (*Salvelinus namaycush*) — also a "trout"
- **California sheephead** `bodianus_pulcher` (*Bodianus pulcher*) — shares the word "california"
