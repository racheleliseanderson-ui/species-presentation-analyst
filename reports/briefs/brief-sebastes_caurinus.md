# Drafting brief — Copper rockfish

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Sebastes caurinus*
Proposed species id: `sebastes_caurinus`
Queued under: G - Pacific

Why it was asked for: Confused with quillback rockfish, which is already written, and with brown and China rockfish. Nearshore rockfish limits are species-specific.
...
- **Quillback rockfish** `sebastes_maliger` (*Sebastes maliger*) — you named it in the note, same genus, also a "rockfish"
