# Drafting brief — Black grouper

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Mycteroperca bonaci*
Proposed species id: `mycteroperca_bonaci`
Queued under: E - snapper and grouper

Why it was asked for: Same genus as the two grouper records already written and the hardest of the three to tell apart. A misidentified black grouper is a closed-season violation.
...
- **Gag grouper** `mycteroperca_microlepis` (*Mycteroperca microlepis*) — same genus, also a "grouper"
- **Scamp** `mycteroperca_phenax` (*Mycteroperca phenax*) — same genus
