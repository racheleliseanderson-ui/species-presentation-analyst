# Drafting brief — Grass carp

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Ctenopharyngodon idella*
Proposed species id: `ctenopharyngodon_idella`
Queued under: C - invasive carp, regulated and constantly misidentified

Why it was asked for: Taken for a common carp on sight. Stocked as triploid in some states, prohibited in others, and unlawful to transport live almost everywhere. Regulated context.
...
- **Common carp** `cyprinus_carpio` (*Cyprinus carpio*) — you named it in the note, also a "carp"
