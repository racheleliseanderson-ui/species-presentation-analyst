# Drafting brief — Black rockfish

Written 2026-09-04. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Sebastes melanops*
Proposed species id: `sebastes_melanops`
Queued under: G - Pacific, where the rockfish set is four records out of roughly sixty

Why it was asked for: The rockfish most nearshore Pacific anglers actually catch, and the catalogue does not have it. Confused with blue and deacon rockfish.
...
- **Silvergray rockfish** `sebastes_brevispinis` (*Sebastes brevispinis*) — same genus, also a "rockfish"
- **Quillback rockfish** `sebastes_maliger` (*Sebastes maliger*) — same genus, also a "rockfish"
- **Vermilion rockfish** `sebastes_miniatus` (*Sebastes miniatus*) — same genus, also a "rockfish"
- **Dusky rockfish** `sebastes_variabilis` (*Sebastes variabilis*) — same genus, also a "rockfish"
