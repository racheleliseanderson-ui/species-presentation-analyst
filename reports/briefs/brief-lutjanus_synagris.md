# Drafting brief — Lane snapper

Written 2026-09-03. This is a brief, not a record. Nothing below is sourced yet.

Scientific name as given: *Lutjanus synagris*
Proposed species id: `lutjanus_synagris`
Queued under: E - snapper and grouper

Why it was asked for: Small, abundant, and routinely kept as a juvenile mutton or gray snapper, which is a limit problem rather than a taste problem.
...
- **Mutton snapper** `lutjanus_analis` (*Lutjanus analis*) — same genus, also a "snapper"
- **Red snapper** `lutjanus_campechanus` (*Lutjanus campechanus*) — same genus, also a "snapper"
