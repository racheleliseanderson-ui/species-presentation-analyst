...
export const LABELS: Record<string, string> = {
  ...
  light: "Light",
  powerful: "Powerful",
  very_powerful: "Very powerful",
  gradual: "Gradual",
  abrupt: "Abrupt",
  brief: "Brief",
  sustained: "Sustained",
  prolonged: "Prolonged",
  short_surges: "Short surges",
  long_runs: "Long runs",
  rare: "Rare",
  occasional: "Occasional",
  frequent: "Frequent",
  rarely_aerial: "Rarely aerial",
  sometimes_aerial: "Sometimes aerial",
  often_aerial: "Often aerial",
  commonly_eaten: "Commonly eaten",
  sometimes_eaten: "Sometimes eaten",
  rarely_eaten: "Rarely eaten",
  regionally_prized: "Regionally prized",
};
