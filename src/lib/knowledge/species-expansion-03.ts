...
export const SPECIES_EXPANSION_03: SpeciesRecord[] = [
  {
    ...
    targetStatusNote:
      "Lower-48 U.S. bull trout remain listed as threatened under the Endangered Species Act. Context only — no presentation guidance. This record is retained for biological context only; we do not give presentation guidance for it.",
    nativeContext:
