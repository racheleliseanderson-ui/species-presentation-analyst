    ...
    entries: [
      {
        ...
        presentationImplication:
          "Dead-drift and tight-line drift remain the reviewed insect-scale jobs; stillwater leans on suspend-pause rather than fast retrieves.",
        invalidators: [
          "treating winter as a surface-terrestrial problem",
      ...
      },
      {
        ...
        movementTendency:
          "Fish redistribute onto feeding water. Spawning gravel is not a target class.",
        thermalContext: "Leaving the cold edge toward the 45–65°F active band.",
        conservationNote:
          "Early-spring spawning overlap is caution, not an aggregation opportunity.",
        presentationImplication:
          "Dead-drift, tight-line drift, and suspended drift fit rising insect delivery.",
      },
      {
        season: "spring",
        ...
        conservationNote:
          "Spring spawner in most inland waters. Spawning gravel and staging water are excluded from target guidance.",
        presentationImplication:
          "Reviewed drift families stay primary; swing is a current-intercept option, not a new family.",
      ...
      },
      {
        ...
        presentationImplication:
          "Stillwater: horizontal retrieve, stop-and-go, or trolling in the usable band. Flowing: drift remains valid in refuge water.",
      ...
      },
      {
        ...
        presentationImplication:
          "Cross-current retrieve and swing can rise when fish, not insects, are the observed forage.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Dead-drift and suspended drift in flowing water; horizontal retrieve or trolling in lakes.",
      },
      {
        season: "spring",
        habitatClass: "Tributary-influenced water, seams, and lake inlets.",
        movementTendency:
          "Many interior forms move into tributaries. That movement is biology, not a pin.",
        conservationNote:
          "Spring spawner. Tributary spawning water is excluded from target guidance.",
        presentationImplication:
          "Dead-drift, swing, surface-drift, and suspended drift remain the reviewed flowing families.",
      ...
      },
      {
        ...
        forageEmphasis:
          "Terrestrials and aquatic insects in streams; zooplankton possible in lakes.",
        presentationImplication:
          "Surface-drift is a reviewed option when terrestrials are observed, not assumed.",
      },
      {
        season: "fall",
        habitatClass: "Lake drop-offs and stream feeding water as temperatures ease.",
        presentationImplication:
          "Horizontal retrieve and stop-and-go in lakes; drift families in rivers.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Suspended open water and basin, often shallower than summer thermocline use.",
        forageEmphasis: "Zooplankton in the remaining pelagic food layer.",
        presentationImplication:
          "Trolling, horizontal retrieve, suspend-pause, and vertical jig — the reviewed stillwater set.",
      },
      {
        season: "spring",
      ...
      },
      {
        ...
        presentationImplication:
          "Trolling and suspend-pause on the usable layer; vertical jig when the band is compact.",
      ...
      },
      {
        ...
        conservationNote:
          "Fall spawner on suitable lake shore or tributary gravel. Mature staging and spawning fish are not a forage-matching problem.",
        presentationImplication:
          "Reviewed families still describe pelagic mechanics for non-ripe fish; spawning fish are an invalidator.",
        invalidators: ["using spawning shore or tributary gravel as a target class"],
      },
      {
        season: "late_fall",
        habitatClass:
          "Spawning overlap continues. Remaining pelagic fish are not a separate concentration class.",
    ...
    entries: [
      {
        ...
        movementTendency:
          "Adults return through freshwater toward lake/tributary spawning systems.",
        feedingEmphasis: "Freshwater adults typically do not feed.",
        presentationImplication:
          "Swing, cross-current retrieve, downstream retrieve, and pulse-jig remain the reviewed flowing families for lawful, non-listed contexts — they do not imply feeding lies.",
        conservationNote:
          "Spawning reaches, staging concentrations, and ESA-listed populations are invalidators, never target layers.",
        invalidators: [
          "converting migration into a trout feeding calendar",
          "using juvenile lake residence as an adult proxy",
        ],
      },
      {
        season: "late_summer",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Deeper edges of wood, docks, and outside weedlines rather than featureless basin.",
        ...
        presentationImplication:
          "Bottom-contact, drop-presentation, and stationary-bait remain the reviewed slow jobs.",
      },
      {
        season: "early_spring",
        habitatClass:
          "Transition from winter cover toward protected shallows as water climbs through the 50s.",
        movementTendency: "Fish redistribute with warming; this is not a GPS path.",
        presentationImplication:
          "Subsurface slow-roll and stop-and-go as fish use mid-depth cover edges.",
      },
      {
        season: "spring",
        habitatClass: "Protected shallows, inside weedline, wood, and docks.",
        conservationNote:
          "Spawns as water holds in the mid-60s; nests in protected shallows. Nests are not a target class.",
        presentationImplication:
          "Reviewed stillwater families stay cover-oriented. Do not add an unreviewed sight-fishing family.",
      ...
      },
      {
        ...
        presentationImplication:
          "Subsurface slow-roll, stop-and-go, surface-retrieve, and drop-presentation — all already reviewed.",
      },
      {
        season: "fall",
        habitatClass: "Points, weed edges, and remaining vegetation as baitfish group.",
        forageEmphasis:
          "Baitfish can rise in importance where shad exist. Capacity is not a current event.",
        presentationImplication:
          "Stop-and-go and subsurface slow-roll on edges; flowing water still uses pulse-jig and stationary-bait.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Bottom-contact, vertical jig, and drop-presentation in still water; bottom-contact drift in current.",
      },
      {
        season: "spring",
        habitatClass: "Rocky shoreline, points, boulder pockets, and current breaks.",
        conservationNote:
          "Spawns on rock in current or on windward lake gravel as water holds near 60°F. Nests are not a target class.",
        lightSensitivity: "Feeds in daylight; wind can move fish shallower on the same rock.",
        presentationImplication:
          "Cross-current retrieve, pulse-jig, and upstream retrieve in flowing water.",
      ...
      },
      {
        ...
        presentationImplication:
          "Cross-current retrieve and pulse-jig in rivers; bottom-contact and stop-and-go on lake rock.",
      },
      {
        season: "fall",
        ...
        presentationImplication:
          "Horizontal retrieve and stop-and-go when bait is the observed forage.",
      },
    ],
    sources: [
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        presentationImplication:
          "Drop-presentation and stop-and-go along channel-adjacent structure.",
      },
      {
        season: "summer",
        habitatClass:
          "Drop-offs, points, breaklines, and outside weedline — more pelagic than largemouth.",
        forageEmphasis: "Shad and other small fish along channel edges.",
        presentationImplication:
          "Horizontal retrieve, vertical jig, and downstream retrieve in current.",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Deep pools, tailwaters, or remaining pelagic bait water depending on declared population.",
        presentationImplication:
          "Trolling, horizontal retrieve, and vertical jig in still water; cross-current retrieve in flow.",
      },
      {
        season: "spring",
        habitatClass: "Flowing water, tailraces, and large tributaries for spawning populations.",
        conservationNote:
          "Flowing-water spawner. Dam tailraces and tributaries are not named pins; spawning concentrations are excluded.",
        presentationImplication:
          "Swing, cross-current retrieve, and downstream retrieve — reviewed flowing families only.",
        invalidators: ["naming spawning rivers as target pins"],
      },
      {
        season: "summer",
        habitatClass:
          "Suspended open water and thermocline edge in reservoirs; current breaks in rivers.",
        depthTendency: "Bright summer midday is often deep.",
        thermalContext:
          "Preferred 55–70°F; 78°F warm edge plus oxygen squeeze can pin the usable layer.",
        presentationImplication:
          "Trolling and vertical jig on the bait layer; pulse-jig in current.",
      },
      {
        season: "fall",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Upriver or windblown-shore spawning run; short and crowded by nature. Exact aggregation points are never named.",
        presentationImplication:
          "Cross-current retrieve, pulse-jig, and downstream retrieve in flow.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Spring spawning moves fish from deeper water toward rivers, tributaries, or shallow lake habitat. Runs are not secret-location outputs.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Sterile hybrids may travel with white bass but do not establish a normal reproductive run.",
        presentationImplication:
          "Cross-current retrieve, downstream retrieve, swing, and pulse-jig.",
      },
      {
        season: "summer",
        habitatClass: "Thermocline edge, points, and suspended open water.",
        thermalContext:
          "Preferred 60–72°F; warm-edge oxygen squeeze is an invalidator for shallow bright water.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        presentationImplication:
          "Vertical jig, trolling, and suspend-pause on the remaining cold, oxygenated layer.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Bottom-contact, slow-drag, drop-presentation, and live-natural-bait suspension.",
      },
      {
        season: "spring",
        habitatClass: "Rocky shoreline, drop-offs, and remaining shallow benthos as ice leaves.",
        forageEmphasis:
          "Benthic crustaceans, mollusks, and eggs of other fishes where those events occur.",
      ...
      },
      {
        ...
        conservationNote:
          "Late-fall to early-winter spawner. Spawning shoals are excluded from target guidance.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Swing and cross-current retrieve in remaining flow; horizontal retrieve in still water.",
      },
      {
        season: "spring",
        habitatClass: "Runs, pool tails, and eddies as insects increase.",
        conservationNote:
          "Spawns in spring to early summer in large-river systems. Spawning concentrations are not used as target recommendations.",
        presentationImplication: "Surface-drift, swing, and cross-current retrieve.",
      },
      {
        season: "summer",
        habitatClass:
          "Upper-column runs and eddies; surface when terrestrials or emergences occur.",
        lightSensitivity: "Low light and turbid water are especially plausible windows.",
        presentationImplication:
          "Surface-drift and downstream retrieve. Surface-retrieve in still water.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Spawns in shallow vegetation when water holds in the 60s. Vegetation spawning is not a target map.",
      ...
      },
      {
        season: "fall",
        habitatClass:
          "Flats remaining warm enough, then a shift toward deeper wintering water in some systems.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Stationary-bait and bottom-contact drift — reviewed families only, not a new filter-net method.",
      },
      {
        season: "spring",
        habitatClass: "Slow channels, side channels, and backwaters as water approaches 60–65°F.",
        conservationNote:
          "Brief spring spawning in flooded margins, marshes, and tributary habitat. Spawning concentrations are not target outputs.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Broadcast spawning over vegetation, mud, and flooded margins is conservation context.",
        presentationImplication: "Bottom-contact and slow-drag.",
      },
      {
        season: "summer",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Spring spawning in shallow quiet water. Gar eggs are toxic and should never be treated as forage or food.",
      ...
      },
      {
        ...
        lightSensitivity:
          "Visual predator; warm calm periods often produce visible near-surface cruising without implying a feeding event.",
        presentationImplication:
          "Horizontal retrieve, stop-and-go, and surface-retrieve — surface does not prove feeding.",
      },
      {
        season: "fall",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Spring spawning. Spawning sites are excluded from target guidance. Eggs are toxic.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Late-spring through summer spawning. Adhesive eggs over vegetation are conservation context. Eggs are toxic.",
        presentationImplication: "Stationary-bait and downstream retrieve.",
      },
      {
        season: "summer",
        ...
        presentationImplication:
          "Horizontal retrieve, stop-and-go, and live-natural-bait suspension.",
      },
      {
        season: "fall",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Successful spawning is linked to warm seasonal flooding and vegetated inundated habitat. Flooded spawning habitat is an invalidator, not a target map.",
      ...
      },
      {
        ...
        lightSensitivity:
          "Surface air-gulping is respiratory behavior and must not be interpreted as surface feeding.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Spawning in protected shallow cavities or depressions. Parental guarding is not a target cue.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Late-spring and summer cavity/depression spawning. Family groups are not target aggregations.",
        presentationImplication: "Stationary-bait and bottom-contact drift.",
      },
      {
        season: "summer",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        conservationNote:
          "Early-summer overlap with parental care. Guarding is not a targeting cue.",
        presentationImplication: "Stationary-bait.",
      },
      {
        season: "summer",
        ...
        lightSensitivity:
          "Low-light and nocturnal feeding are common; turbid water can extend activity into daylight.",
        presentationImplication: "Bottom-contact, slow-drag, and live-natural-bait suspension.",
      },
      {
        season: "fall",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Deep pools, current breaks, wood, and lake basins in the remaining active band.",
        ...
        presentationImplication:
          "Dead-drift and bottom-contact drift in flowing water; suspend-pause or stop-and-go in still water.",
      ...
      },
      {
        ...
        forageEmphasis: "Aquatic insects and emergences where they occur.",
        presentationImplication:
          "Dead-drift, surface-drift, and swing remain reviewed flowing families.",
      ...
      },
      {
        ...
        presentationImplication:
          "Bottom-contact drift and cross-current retrieve in flow; surface-retrieve only when terrestrials are observed, not assumed.",
      ...
      },
      {
        ...
        presentationImplication:
          "Dead-drift, swing, and cross-current retrieve. Do not convert spawn color into a new family.",
        invalidators: [
          "using spawning substrate as holding water",
          "assuming an egg event from calendar alone",
        ],
      },
      {
        season: "late_fall",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        season: "spring",
        habitatClass:
          "Undercuts, seams, side channels, and pond inlets as water warms off the cold edge.",
      ...
      },
      {
        ...
        thermalContext:
          "Preferred 46–56°F. Warm edge near 68°F. Warm lowland water is an invalidator.",
        coverUse: "Undercuts, wood, and shade.",
        presentationImplication:
          "Surface-drift and dead-drift in remaining cold water; stillwater: horizontal retrieve or surface-retrieve when terrestrials are observed.",
      ...
      },
      {
        ...
        conservationNote:
          "Fall spawner over groundwater-influenced gravel. Redds are excluded from target guidance.",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Shallower relative to summer: basins, humps, and rocky shoreline in ice-influenced lakes.",
      ...
      },
      {
        season: "spring",
        habitatClass:
          "Rocky shoreline, points, drop-offs, and remaining shallow structure before stratification.",
      ...
      },
      {
        ...
        thermalContext:
          "Preferred 42–52°F. Warm edge near 60°F. Surface presence is usually a cold-water exception.",
        presentationImplication: "Trolling, vertical jig, and suspend-pause on the usable layer.",
        invalidators: [
          "forcing a summer surface default",
          "ignoring the temperature-oxygen squeeze",
        ],
      },
      {
        season: "fall",
        ...
        conservationNote:
          "Fall spawner on rocky reefs. Spawning substrate is excluded from target guidance. Do not name reefs.",
        presentationImplication:
          "Horizontal retrieve and trolling off the spawning substrate, not on it.",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Runs, seams, tailwater, deep pools, and boulder pockets adjacent to strong current.",
        depthTendency: "Often near bottom.",
        feedingEmphasis:
          "Do not convert presence into a hatch match. Many winter fish are not feeding in the trout sense.",
        thermalContext: "Preferred 42–55°F; cold edge near 36°F.",
        conservationNote:
          "Winter-run spawning overlap is caution. Spawning gravel is excluded from target guidance.",
        presentationImplication:
          "Swing, bottom-contact drift, dead-drift, and downstream retrieve — the reviewed flowing families only.",
        invalidators: [
          "treating winter steelhead as inland rainbow nymphing by default",
          "using spawning gravel as holding water",
        ],
      },
      {
        season: "early_spring",
        habitatClass:
          "Travel lanes and holding lies as some winter-run fish continue and others spawn.",
        conservationNote:
          "Early-spring overlap with spawning. Winter and summer-run stocks still must not be collapsed.",
      ...
      },
      {
        season: "summer",
        habitatClass:
          "Summer-run stocks may be in river systems; heat and low flow are constraints.",
        thermalContext:
          "Warm edge near 65°F. Low flow and heat are invalidators, not a shallow feeding cue.",
        ...
        invalidators: [
          "collapsing summer-run into the winter-run calendar",
          "forcing stillwater families — this record has none",
        ],
      },
      {
        season: "fall",
        habitatClass:
          "Holding and travel water as some summer-run fish continue and winter-run fish have not yet arrived as a single story.",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Basins, drop-offs, breaklines, and deep river pools in the remaining active band.",
        depthTendency: "Deeper in daylight; shallower in low light.",
        feedingEmphasis: "Slow, lower-column intercept of forage fish.",
        thermalContext: "Near or below the 42°F cold edge, activity compresses.",
        presentationImplication:
          "Vertical jig, slow drag, and bottom contact in still water; bottom-contact drift and pulse / jig in current.",
      ...
      },
      {
        ...
        movementTendency:
          "Fish redistribute with temperature and flow. Rock and gravel are not a target class.",
        thermalContext:
          "Leaving the cold edge toward the 48–72°F active band. Minnesota DNR: spawning peaks near 42–50°F.",
        conservationNote:
          "Early-spring spawning overlap is caution. Spawning substrate is excluded from target guidance. Do not name reefs.",
        presentationImplication:
          "Bottom-contact drift, pulse / jig, and cross-current retrieve in flow; slow drag and bottom contact in still water.",
        invalidators: ["using spawning substrate as holding water"],
      },
      {
        season: "spring",
        ...
        forageEmphasis:
          "Forage fish where they occur. Do not infer a perch event from the calendar.",
        presentationImplication:
          "Trolling, slow drag, and vertical jig in still water; bottom-contact drift and downstream retrieve in flow.",
      },
      {
        season: "summer",
        ...
        thermalContext:
          "Preferred 55–68°F. Warm edge near 76°F. Southern reservoirs depend on a cool hypolimnion.",
        lightSensitivity:
          "Strong low-light and night feeding. Bright midday in clear water is often a poor feeding window, not a location problem.",
        presentationImplication:
          "Vertical jig, trolling, and slow drag on the usable layer; live / natural bait suspension where the band is known. Flowing water: pulse / jig and bottom-contact drift.",
        invalidators: [
          "forcing a bright shallow default in clear water",
          "collapsing lake-resident and large-river calendars",
        ],
      },
      {
        season: "fall",
        ...
        presentationImplication:
          "Trolling, slow drag, and cross-current retrieve. Do not convert cooling water into an unreviewed family.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Bottom-contact drift and pulse / jig. Still water, where it occurs: vertical jig, slow drag, and bottom contact.",
      },
      {
        season: "early_spring",
        habitatClass:
          "Deep runs, pool heads, and current-washed rock as flow and temperature rise.",
        conservationNote:
          "Early-spring spawning overlap is caution. Adhesive eggs on rubble are biology. Dam and spawning-run concentrations are excluded from target guidance.",
        presentationImplication: "Bottom-contact drift, pulse / jig, and cross-current retrieve.",
        invalidators: [
          "using spawning rubble as holding water",
          "naming tailwaters as aggregation targets",
        ],
      },
      {
        season: "summer",
        ...
        presentationImplication:
          "Bottom-contact drift and pulse / jig. Still water: vertical jig and bottom contact.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Stop-and-go, subsurface slow-roll, and horizontal retrieve. Flowing water: cross-current retrieve and stationary bait.",
      },
      {
        season: "early_spring",
        habitatClass: "Weedy shallows, inlets, side channels, and eddies as ice leaves.",
        movementTendency:
          "Fish redistribute into shallow vegetation. That vegetation is not a target class.",
        conservationNote:
          "Michigan DNR: spawn in the shallows right after ice-out, before muskellunge. Vegetated ice-out water is excluded from target guidance.",
      ...
      },
      {
        ...
        depthTendency:
          "Deeper than the cool-water shallow default. Michigan DNR: retreat somewhat deeper in midsummer.",
        thermalContext:
          "Preferred 50–65°F. Warm edge near 75°F. Warm weedy southern water may be thermal stress, not feeding.",
        coverUse: "Deeper weed edges and cooler ambush structure.",
        presentationImplication:
          "Subsurface slow-roll, stop-and-go, and horizontal retrieve. Surface retrieve is not the summer default.",
        invalidators: [
          "forcing a bright shallow summer default",
          "treating thermally stressed southern pike as feeding fish",
        ],
      },
      {
        season: "fall",
        ...
        presentationImplication:
          "Stop-and-go, horizontal retrieve, subsurface slow-roll, and cross-current retrieve. Surface retrieve only as a reviewed stillwater family, not a new one.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Horizontal retrieve, stop-and-go, and subsurface slow-roll. Flowing water: swing and cross-current retrieve.",
      },
      {
        season: "spring",
        habitatClass: "Weed edges, points, inlets, and current breaks as water leaves ice-out.",
        conservationNote:
          "Michigan DNR: spawn in early spring after ice-out, after northern pike. Vegetated shallows are excluded from target guidance. Do not name aggregation sites.",
      ...
      },
      {
        ...
        thermalContext:
          "Preferred 55–70°F. Warm edge near 80°F. Bright high-sky days often pin fish to cover.",
        lightSensitivity: "Low light and weather changes matter more than a noon-flat default.",
        presentationImplication:
          "Horizontal retrieve, stop-and-go, and subsurface slow-roll. Surface retrieve is not the bright-summer default.",
      ...
      },
      {
        ...
        presentationImplication:
          "Horizontal retrieve, stop-and-go, subsurface slow-roll, and cross-current retrieve.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Stop-and-go, subsurface slow-roll, and horizontal retrieve. Flowing water: stationary bait and cross-current retrieve.",
      },
      {
        season: "early_spring",
        habitatClass:
          "Weed edges, inside weedlines, and shallow flats adjacent to cover as water warms.",
        conservationNote:
          "Early-spring spawning in flooded vegetation. Flooded margins are never named as aggregation targets.",
      ...
      },
      {
        ...
        thermalContext:
          "Preferred 60–70°F. Warm edge near 82°F. More at home in warm vegetated water than northern pike.",
        coverUse: "Vegetation and wood. Open pelagic water is a mismatch.",
        presentationImplication:
          "Stop-and-go, subsurface slow-roll, and horizontal retrieve. Surface retrieve along weed edges is a reviewed stillwater family, not a new one.",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Basins, drop-offs, and submerged humps; also shallower ice-cover water. Michigan DNR: active under ice in both shallow and deeper water.",
      ...
      },
      {
        ...
        conservationNote:
          "Michigan DNR: spawn in spring, laying gelatinous egg strings over vegetation, roots, and fallen trees. That habitat is excluded from target guidance.",
      ...
      },
      {
        season: "summer",
        habitatClass:
          "Weed edges, drop-offs, and points. Michigan DNR: rarely taken from water more than about 30 feet; summer is deeper than spring/fall, not a deep-basin default.",
        depthTendency:
          "Mid-depth along a break. Follows the cooler band — Michigan DNR notes a preference near 66–70°F.",
        thermalContext: "Preferred 54–68°F. Warm edge near 76°F.",
        presentationImplication:
          "Vertical jig, slow drag, and drop presentation. Flowing water: bottom-contact drift and pulse / jig.",
      ...
      },
      {
        ...
        forageEmphasis:
          "Insects and small forage fish. A school is a moving aggregation, not a named pin.",
        presentationImplication:
          "Vertical jig, slow drag, drop presentation, and live / natural bait suspension.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Vertical jig, suspend / pause, and slow drag. Live / natural bait suspension where the band is known.",
        invalidators: ["treating winter as a shallow-weed bluegill problem"],
      },
      {
        season: "spring",
        habitatClass:
          "Wood, dock shade, weed edges, and inlets as water holds in the upper 50s to mid-60s.",
        conservationNote:
          "Minnesota DNR: spawn in May and June in the mid-60s; males guard nests in colonies. Colonial wood is excluded from target guidance.",
        presentationImplication:
          "Drop presentation, suspend / pause, and pulse / jig. Stationary bait in slack.",
      ...
      },
      {
        ...
        lightSensitivity:
          "Night, dawn, and dusk feeding windows are optically more plausible. That does not imply a catch.",
        presentationImplication:
          "Suspend / pause, drop presentation, and live / natural bait suspension. Vertical jig when fish are marked in the column.",
        invalidators: [
          "forcing a bright open-flat default",
          "collapsing black and white habitat splits into one depth rule",
        ],
      },
      {
        season: "fall",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Drop presentation, slow drag, and live / natural bait suspension. Flowing slack: dead drift and stationary bait.",
      },
      {
        season: "early_summer",
        habitatClass: "Weed edges, inside weedlines, and shallow flats as water holds near 65°F.",
        conservationNote:
          "Michigan DNR: spawns in the shallows when water reaches about 65°F. Catalog exception: bed targeting of spawning colonies is never a recommendation.",
      ...
      },
      {
        ...
        presentationImplication:
          "Drop presentation and slow drag. Surface retrieve only when terrestrials are observed, not assumed. Flowing slack: dead drift.",
      ...
      },
      {
        ...
        presentationImplication:
          "Drop presentation, slow drag, and live / natural bait suspension.",
      },
    ],
    sources: [
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        season: "early_summer",
        habitatClass:
          "Weed edges, inside weedlines, and shallow flats as littoral water warms into the upper 60s.",
        conservationNote:
          "Colonial or concentrated nesting habitat is excluded from target guidance.",
        presentationImplication:
          "Drop presentation and dead drift in slack. Pulse / jig along cover.",
        invalidators: ["using nesting colonies as holding water"],
      },
      {
        season: "summer",
        ...
        presentationImplication:
          "Drop presentation, slow drag, and live / natural bait suspension. Surface retrieve only when terrestrials are observed.",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Deeper weed edges, drop-offs, and remaining bottom cover in the usable band.",
      ...
      },
      {
        season: "spring",
        habitatClass:
          "Weed edges, outside weedlines, and shallow flats as water warms toward 70–75°F.",
        conservationNote:
          "Spawning commonly in warm shallow water, often somewhat deeper than bluegill nests. Colonies are excluded from target guidance.",
        presentationImplication:
          "Slow drag, drop presentation, and bottom-contact drift in protected slack.",
        invalidators: ["using nesting colonies as holding water"],
      },
      {
        season: "summer",
        habitatClass:
          "Weed edges, outside weedlines, wood, and drop-offs — as bottom, not as a surface edge.",
        depthTendency: "Often slightly deeper littoral water than bluegill.",
        thermalContext: "Preferred 72–81°F. Most active in daylight.",
        presentationImplication:
          "Bottom contact, slow drag, drop presentation, and live / natural bait suspension. Pulse / jig on the bottom of protected water.",
      ...
      },
      {
        ...
        forageEmphasis:
          "Mollusks and remaining benthic invertebrates. Do not infer a snail event from the calendar.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Drop presentation, slow drag, and stop-and-go. Flowing water: stationary bait and dead drift.",
      },
      {
        season: "spring",
        habitatClass:
          "Wood, weed edges, riprap, and stream pools as water warms into the upper 60s.",
        conservationNote:
          "Nests in shallow colonies on gravel or rock. Colonies are excluded from target guidance.",
        presentationImplication:
          "Drop presentation, pulse / jig, and cross-current retrieve along cover.",
        invalidators: ["using nesting colonies as holding water"],
      },
      {
        season: "summer",
        ...
        thermalContext:
          "Preferred 70–82°F. Tolerates turbidity and silt better than pumpkinseed or redear.",
        coverUse: "Structure first. Open flats are a mismatch.",
        presentationImplication:
          "Drop presentation, stop-and-go, and slow drag. Surface retrieve along cover when terrestrials are observed. Flowing water: dead drift and pulse / jig.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Bottom contact, drop presentation, and stop-and-go. Flowing water: bottom-contact drift and stationary bait.",
      },
      {
        season: "spring",
        habitatClass:
          "Rocky shoreline, riprap, points, boulder pockets, and pool heads as water warms.",
        conservationNote:
          "Michigan DNR: spawn from April to early June; males guard nests. Nests are excluded from target guidance.",
        presentationImplication: "Cross-current retrieve, pulse / jig, and bottom-contact drift.",
      ...
      },
      {
        ...
        thermalContext:
          "Preferred 68–76°F. Evening and early morning feeding is optically more plausible.",
        presentationImplication:
          "Horizontal retrieve, stop-and-go, bottom contact, and drop presentation. Flowing water: pulse / jig and cross-current retrieve.",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Drop presentation, slow drag, and live / natural bait suspension. Flowing water: dead drift and stationary bait.",
      },
      {
        season: "spring",
        habitatClass:
          "Pool tails, current breaks, wood, and rocky or sandy margins as water warms into the 60s.",
        conservationNote:
          "South Carolina DNR: spawn late May through July at about 65–75°F; nests may be solitary or in groups of more than 80. Colonies are excluded from target guidance.",
        presentationImplication:
          "Drop presentation, pulse / jig, and dead drift along cover. Stationary bait in slack.",
        invalidators: ["using grouped nests as holding water"],
      },
      {
        season: "early_summer",
        habitatClass:
          "Pools, current margins, wood, and rocky shoreline. Nesting overlap continues.",
        conservationNote:
          "Virginia DWR: spawn between May and July; males guard. Guarded nests remain caution.",
        presentationImplication:
          "Drop presentation, slow drag, and pulse / jig. Flowing water: dead drift.",
      },
      {
        season: "summer",
        habitatClass:
          "Pool tails, runs as margins, wood, rocky shoreline, and weed edges — as cover, not as a bluegill pond flat.",
        thermalContext:
          "Preferred 68–80°F. Virginia DWR: can inhabit faster water than many sunfish, still off the fastest lane.",
        lightSensitivity:
          "Daylight sight feeder; shade and broken light improve shallow cover use.",
        presentationImplication:
          "Drop presentation and slow drag. Surface retrieve only when terrestrials are observed, not assumed. Flowing water: dead drift and pulse / jig.",
        invalidators: [
          "importing a still-water bluegill default into a river pool",
          "collapsing redbreast into longear",
        ],
      },
      {
        season: "fall",
    ...
    entries: [
      {
        ...
        presentationImplication:
          "Drop presentation, slow drag, and stop-and-go. Flowing slack: stationary bait.",
      },
      {
        season: "spring",
        habitatClass:
          "Wood, weed edges, stumps, and quiet stream margins as water warms toward 71°F.",
        conservationNote:
          "Texas Parks and Wildlife: spawn when water reaches about 71°F and continuing through summer. FWC: solitary nesters adjacent to a submerged object. Nests are excluded from target guidance.",
        presentationImplication:
          "Drop presentation, pulse / jig, and stop-and-go. Flowing water: stationary bait and cross-current retrieve along cover.",
        invalidators: ["using guarded nests as holding water"],
      },
      {
        season: "early_summer",
        ...
        conservationNote:
          "FWC: often more than once a year, usually between April and August. Nesting remains caution.",
      ...
      },
      {
        ...
        thermalContext:
          "Preferred 70–82°F. FWC: more tolerance for muddy water than most species. FWC: most feeding in the morning.",
        coverUse: "Structure first. Open flats are a mismatch.",
        presentationImplication:
          "Drop presentation, stop-and-go, and slow drag. Surface retrieve along cover when terrestrials are observed. Flowing water: pulse / jig and cross-current retrieve.",
        invalidators: [
          "treating warmouth as rock bass",
          "importing a round-pond bluegill default into stump cover",
        ],
      },
      {
        season: "fall",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        season: "early_summer",
        habitatClass:
          "Clear stream pools, inlets, overflow water, and vegetated rocky or sandy margins.",
        conservationNote:
          "Missouri DNR: nests in colonies from mid-May to early or mid-August; rims often nearly touch. Colonies are excluded from target guidance.",
      ...
      },
      {
        season: "summer",
        habitatClass:
          "Pools, inlets, overflow water, weed edges, and rocky shoreline adjacent to moving water.",
        thermalContext:
          "Preferred 68–80°F. Missouri DNR: most active in daytime. Avoids strong currents.",
        lightSensitivity: "Clear water increases visual feeding and shade use at high sun.",
        presentationImplication:
          "Drop presentation and slow drag. Surface retrieve only when terrestrials are observed. Flowing water: dead drift, pulse / jig, and stationary bait.",
        invalidators: [
          "collapsing longear into redbreast",
          "forcing a still-water bluegill pond default",
        ],
      },
      {
        season: "late_summer",
        ...
        conservationNote:
          "Missouri DNR: male remains with the nest for more than two weeks. Nesting remains caution.",
        presentationImplication:
          "Drop presentation, slow drag, and live / natural bait suspension.",
      },
      {
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        season: "spring",
        habitatClass:
          "Weeds, wood, sloughs, and protected backwater as water holds in the mid-50s to mid-60s.",
        conservationNote:
          "South Carolina DNR: spawning begins earlier than most sunfish, around March to May at about 55–65°F; nests often in groups. Grouped nests are excluded from target guidance.",
        presentationImplication:
          "Drop presentation, pulse / jig, and live / natural bait suspension. Dead drift in slack.",
        invalidators: ["using grouped nests as holding water"],
      },
      {
        season: "summer",
        habitatClass:
          "Weed edges, inside weedlines, wood, sloughs, and low-flowing vegetated water.",
        thermalContext:
          "Preferred 62–76°F. Slack, tannic or clear backwater — not a river-current sunfish problem.",
        coverUse: "Vegetation and wood first. Open current is a mismatch.",
        presentationImplication:
          "Drop presentation, slow drag, and live / natural bait suspension. Surface retrieve along cover when terrestrials are observed. Flowing slack: pulse / jig and dead drift.",
        invalidators: [
          "treating flier as crappie",
          "importing a river-current sunfish default into backwater",
        ],
      },
      {
        season: "fall",
    ...
    entries: [
      {
        ...
        depthTendency:
          "Minnesota DNR: deep water and protection from current. In large rivers they may winter near flathead without sharing diet.",
        feedingEmphasis: "Slow bottom intercept.",
        presentationImplication:
          "Bottom contact, slow drag, and live / natural bait suspension. Flowing water: bottom-contact drift and stationary bait.",
        invalidators: ["treating winter as a night-shallow riffle problem"],
      },
      {
        season: "spring",
        habitatClass:
          "Pools, current breaks, wood, and tributary mouths as water warms. Minnesota DNR: may move far upstream — a movement class, not a named reach.",
        presentationImplication:
          "Stationary bait, bottom-contact drift, and pulse / jig along cover.",
      },
      {
        season: "early_summer",
        habitatClass:
          "Deep pools, wood, undercut banks, and current breaks as water holds near 75°F.",
        conservationNote:
          "Missouri DNR / Texas Parks and Wildlife: male selects a dark secluded cavity; male guards eggs and fry. Cavities are excluded from target guidance.",
      ...
      },
      {
        season: "summer",
        habitatClass:
          "Day: deep water, drift, and wood. Night: riffles and pool shallows (Missouri DNR).",
        thermalContext: "Preferred 70–82°F. Warm edge near 90°F.",
        lightSensitivity:
          "Primarily low light and night in clear water; stain and current can extend daytime feeding.",
        presentationImplication:
          "Bottom contact, slow drag, and live / natural bait suspension. Flowing water: stationary bait, bottom-contact drift, and pulse / jig.",
        invalidators: [
          "forcing a live-fish-only flathead default",
          "forcing a reservoir-roaming blue-catfish default",
        ],
      },
      {
        season: "fall",
        habitatClass:
          "Pools and deeper current protection as fish move downstream (Minnesota DNR).",
        presentationImplication: "Bottom contact, slow drag, and stationary bait.",
      },
    ],
    sources: [
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Texas Parks and Wildlife: downstream toward warmer water. Deep channels, basins, and current-protected holes.",
        feedingEmphasis: "Remaining fish and invertebrates in the usable band.",
        presentationImplication:
          "Bottom contact, slow drag, and live / natural bait suspension. Vertical jig when fish are in the column. Flowing water: bottom-contact drift and stationary bait.",
        invalidators: ["treating winter as a shallow-cover pond-channel problem"],
      },
      {
        season: "spring",
        habitatClass:
          "Channels, current breaks, points, and basins as water warms toward the low 70s.",
        presentationImplication:
          "Stationary bait, pulse / jig, and bottom-contact drift. Vertical jig in reservoirs when fish are off the bottom.",
      },
      {
        season: "early_summer",
        habitatClass:
          "Channels, structure, and protected low-current water as water holds about 70–75°F.",
        conservationNote:
          "Virginia DWR / NOAA: spawn once per year in late spring and early summer. Males are primary nest caretakers. Cavities and smaller tributary nesting water are excluded from target guidance.",
        presentationImplication:
          "Stationary bait and bottom contact off nesting structure, not on it.",
        invalidators: ["using nesting cavities as holding water"],
      },
      {
        season: "summer",
        habitatClass:
          "Texas Parks and Wildlife: upstream toward cooler water. Large-river channels and, in reservoirs, forage-linked open water.",
        thermalContext:
          "Preferred 72–84°F. North Carolina Wildlife: often favor faster currents than other catfish.",
        lightSensitivity:
          "Virginia DWR: deep holes in peak daylight; shallower moving water in low light. Daytime feeding remains plausible with current and turbidity.",
        presentationImplication:
          "Bottom contact, slow drag, live / natural bait suspension, and vertical jig. Flowing water: stationary bait, bottom-contact drift, and pulse / jig.",
        invalidators: [
          "forcing a solitary flathead wood default",
          "collapsing river-channel and reservoir-roaming jobs into one depth rule",
        ],
      },
      {
        season: "fall",
        ...
        forageEmphasis:
          "Fish and remaining invertebrates. Do not infer a bait event from the calendar.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        presentationImplication:
          "Stationary bait, pulse / jig, and bottom-contact drift along cover.",
      },
      {
        season: "early_summer",
        habitatClass:
          "Wood, cavities, and protected pools as water holds in the low-to-mid 70s, often somewhat later than channel catfish (Missouri DNR).",
        conservationNote:
          "Cavity nesting; male guards eggs and fry. Cavities and fry schools are excluded from target guidance.",
        presentationImplication: "Stationary bait and bottom contact off the cavity, not in it.",
        invalidators: ["using nesting cavities as holding water"],
      },
      {
        season: "summer",
        habitatClass:
          "Day: a favorite deep-cover object. Night: shallows and pool edges off that cover (Missouri DNR / Texas Parks and Wildlife).",
        thermalContext:
          "Preferred 68–82°F. Texas Parks and Wildlife: spawn can continue at 75–80°F.",
        ...
        presentationImplication:
          "Bottom contact, slow drag, and live / natural bait suspension. Flowing water: stationary bait, bottom-contact drift, and pulse / jig.",
        invalidators: [
          "forcing a channel-catfish omnivore default",
          "forcing a reservoir-roaming blue-catfish default",
        ],
      },
      {
    ...
    entries: [
      {
        ...
        feedingEmphasis: "Slow bottom intercept of remaining invertebrates.",
        presentationImplication:
          "Bottom contact, slow drag, and live / natural bait suspension. Flowing slack: stationary bait and bottom-contact drift.",
      },
      {
        season: "spring",
      ...
      },
      {
        ...
        conservationNote:
          "Cavity or depression spawning around banks, roots, and structure. Guarded nests are excluded from target guidance. Exact temperature tables remain a gap.",
        presentationImplication:
          "Stationary bait and bottom contact off nesting structure, not on it.",
        invalidators: ["using nesting cavities as holding water"],
      },
      {
        season: "summer",
        habitatClass:
          "Connecticut DEEP: backwaters and slow-moving areas of larger rivers and streams, plus lakes and ponds.",
        thermalContext: "Preferred 68–80°F.",
        lightSensitivity: "More daylight-capable than many bullheads; still a bottom-contact fish.",
        presentationImplication:
          "Bottom contact, slow drag, and live / natural bait suspension. Flowing slack: stationary bait, bottom-contact drift, and pulse / jig.",
        invalidators: [
          "treating white catfish as channel catfish",
          "inheriting a bullhead night-only default",
        ],
      },
      {
        season: "fall",
    ...
    entries: [
      {
        season: "spring",
        habitatClass:
          "Great Lakes pelagic water — thermocline edges, suspended open water, drop-offs, and points as classes. Pacific ocean feeding is behind or beside this overlay, not a river feeding calendar.",
        feedingEmphasis:
          "Older fish on other fish where lake fish are still feeding. Capacity is not a current bait event.",
        presentationImplication:
          "Trolling, Vertical jig, and Horizontal retrieve remain the reviewed stillwater families for lake fish that are feeding. They do not apply to Pacific freshwater spawners.",
        invalidators: [
          "treating spring Chinook as inland rainbow nymphing",
          "collapsing Great Lakes feeding into a river-spawn calendar",
        ],
      },
      {
        season: "summer",
        habitatClass:
          "Lake fish along the cool pelagic layer. Pacific freshwater return has not yet become the default story.",
        depthTendency:
          "Often deep or suspended; bright conditions push lake fish down along the thermocline.",
        thermalContext: "Preferred 44–55°F; warm edge near 64°F.",
        presentationImplication:
          "Trolling and Vertical jig on the usable lake layer. Flowing families stay off this lake job.",
        invalidators: ["forcing a river-spawn calendar onto lake fish"],
      },
      {
        season: "late_summer",
        habitatClass:
          "Pacific freshwater travel lanes, runs, deep pools, seams, tailwater, and current breaks as classes. Great Lakes lake feeding may still be underway elsewhere — do not collapse them.",
        feedingEmphasis: "Pacific freshwater adults are interception, not forage matching.",
        presentationImplication:
          "Swing, Downstream retrieve, and Bottom-contact drift remain the reviewed flowing families for lawful, non-listed contexts — they do not imply feeding lies.",
        conservationNote:
          "NOAA: return generally in summer or early fall. Listed ESUs and redds are invalidators, never target layers.",
      ...
      },
      {
        ...
        conservationNote:
          "NOAA: all Chinook salmon die after spawning. Redds and listed ESUs stay excluded from target guidance.",
        presentationImplication:
          "Swing, Downstream retrieve, and Bottom-contact drift remain interception mechanics only where harvest is lawful and the population is not listed.",
        invalidators: [
          "naming spawning reaches or bottlenecks",
          "using a hatch match on spawning adults",
        ],
      },
    ],
    sources: [
    ...
    entries: [
      {
        season: "spring",
        habitatClass:
          "Great Lakes pelagic water — thermocline edges, suspended open water, points, and inlets as classes. Not a Pacific river-return calendar.",
        feedingEmphasis:
          "Small forage fish where lake fish are feeding. Insects remain juvenile capacity.",
        presentationImplication:
          "Horizontal retrieve, Trolling, and Stop-and-go remain the reviewed stillwater families for lake fish that are feeding.",
        invalidators: ["collapsing Great Lakes feeding into a river-spawn calendar"],
      },
      {
        season: "summer",
        habitatClass:
          "Lake fish often higher in the column than Chinook. Bright conditions still do not invent a surface event.",
        thermalContext: "Preferred 46–56°F; warm edge near 65°F.",
        presentationImplication:
          "Horizontal retrieve, Trolling, and Stop-and-go on the usable lake layer.",
        invalidators: ["forcing Chinook deep-trolling language onto coho by default"],
      },
      {
        season: "fall",
        habitatClass:
          "Pacific freshwater travel lanes — runs, seams, pool heads, current breaks, and tributary mouths as classes.",
        feedingEmphasis: "Pacific freshwater adults are interception, not forage matching.",
        presentationImplication:
          "Swing, Cross-current retrieve, and Downstream retrieve remain the reviewed flowing families for lawful, non-listed contexts — they do not imply feeding lies.",
        conservationNote:
          "NOAA: females dig redds; all coho die after spawning. Do not crowd spawning tributaries. California and federal listings stay fail-closed where they apply.",
        invalidators: [
          "treating tributary-mouth habitat as a targeting prescription",
          "targeting redds",
        ],
      },
      {
        season: "winter",
        habitatClass:
          "NOAA: some returns continue into early winter. Remaining Great Lakes lake fish are a separate job from Pacific freshwater travel.",
        conservationNote:
          "Early-winter spawning overlap is caution. Listed ESUs remain invalidators.",
        presentationImplication:
          "Swing, Cross-current retrieve, and Downstream retrieve as interception mechanics only where the fishery is lawful.",
    ...
    entries: [
      {
        season: "summer",
        habitatClass:
          "Coastal river travel lanes — runs, pool heads, pool tails, current breaks, and tributary mouths as classes.",
        feedingEmphasis:
          "Alaska DFG: adults returning to spawn do not eat. Ocean feeding is behind them.",
        thermalContext: "Preferred 44–58°F.",
        presentationImplication:
          "Swing, Cross-current retrieve, Downstream retrieve, and Pulse / jig remain the reviewed flowing families — they describe interception/reaction, not feeding lies.",
        conservationNote:
          "NOAA: odd-year and even-year populations are independent. Abundance must not be inferred from habitat.",
        invalidators: [
          "treating returning pinks as feeding trout",
          "adding stillwater families — this record has none",
        ],
      },
      {
        season: "late_summer",
        ...
        presentationImplication:
          "Swing, Cross-current retrieve, Downstream retrieve, and Pulse / jig as interception mechanics only.",
      ...
      },
      {
        ...
        conservationNote:
          "NOAA: all pink salmon die after they spawn. Redds and concentrated spawning fish are excluded from target guidance.",
        presentationImplication:
          "Reviewed flowing families remain interception only where harvest is lawful.",
        invalidators: ["naming spawning reaches or bottlenecks", "forcing a stillwater calendar"],
      },
    ],
    sources: [
      {
        label: "Alaska Department of Fish and Game Pink Salmon species profile",
        class: "agency",
    ...
    entries: [
      {
        season: "late_summer",
        habitatClass:
          "Coastal river travel lanes — runs, current breaks, pool heads, pool tails, and tributary mouths as classes.",
        feedingEmphasis: "Alaska DFG: adults cease feeding and the digestive tract degrades.",
        presentationImplication:
          "Swing, Cross-current retrieve, Downstream retrieve, and Pulse / jig remain the reviewed flowing families — interception/reaction, not feeding lies.",
        conservationNote:
          "Hood Canal summer-run and Columbia River ESUs are federally threatened (NOAA). Status is an invalidator, never a target layer.",
        invalidators: [
          "treating returning chum as feeding trout",
          "adding stillwater families — this record has none",
        ],
      },
      {
        ...
        presentationImplication:
          "Swing, Cross-current retrieve, Downstream retrieve, and Pulse / jig as interception mechanics only where the fishery is lawful and unlisted.",
      ...
      },
      {
        ...
        conservationNote:
          "NOAA: spawn from late summer to March. Spawning concentrations are excluded from target guidance.",
      ...
      },
      {
        season: "winter",
        habitatClass:
          "NOAA: peak spawning can be concentrated in early winter when river flows are high. Hydrology, not a named bottleneck.",
        conservationNote:
          "Listed ESUs stay fail-closed regardless of season. Spawners are not a feeding problem.",
        presentationImplication:
          "Swing and Pulse / jig remain interception mechanics only where harvest is lawful.",
        invalidators: [
          "forcing a stillwater calendar",
          "using listed ESU names as a place to fish",
        ],
      },
    ],
    sources: [
      ...
      {
        label: "Alaska Department of Fish and Game Chum Salmon species profile",
        class: "agency",
    ...
    entries: [
      {
        season: "winter",
        habitatClass:
          "Lake basins, thermocline remnants, drop-offs, and suspended open water in the remaining cold band.",
        depthTendency: "Deeper than spring surface water.",
        feedingEmphasis: "Pelagic forage fish. Insects recede.",
        thermalContext: "Near or below the 40°F cold edge, activity compresses.",
        presentationImplication:
          "Trolling, Vertical jig, and Suspend / pause remain the reviewed stillwater winter jobs.",
        invalidators: ["treating winter as a brown-trout wood problem"],
      },
      {
        season: "spring",
        habitatClass:
          "Higher pelagic water in lakes; cold river runs, seams, and pool heads in connected flowing water.",
        feedingEmphasis:
          "Smelt-scale forage in lakes; aquatic and emerging insects in rivers. Capacity is not a hatch.",
        presentationImplication:
          "Trolling, Horizontal retrieve, and Surface retrieve in still water; Dead drift, Swing, and Surface drift in current.",
      },
      {
        season: "summer",
        habitatClass:
          "Cold oxygenated lake water — thermocline edges, basins, drop-offs. Rivers that stay cold enough remain usable.",
        depthTendency:
          "Catalog: commonly descends into cold oxygenated water during summer stratification.",
        thermalContext:
          "Maine IFW: prefer water temperatures below 65°F. Catalog warm edge near 68°F.",
        presentationImplication:
          "Trolling, Vertical jig, and Suspend / pause on the usable cold layer. Flowing water: Dead drift and Swing where temperature allows.",
        invalidators: [
          "forcing a warm surface default",
          "collapsing this record into brown trout summer cover",
        ],
      },
      {
        season: "fall",
        habitatClass:
          "Cooling pelagic water; river runs as some fish move toward inlet and outlet spawning systems.",
        forageEmphasis:
          "Forage continues until spawning overlap. Do not infer a smelt event from the calendar.",
        presentationImplication:
          "Trolling and Horizontal retrieve in lakes; Dead drift, Swing, Cross-current retrieve, and Surface drift in current.",
        conservationNote:
          "Maine IFW: wild fish spawn from mid-October through late November in lake inlets or outlets. That window is an invalidator, not a target map.",
        invalidators: [
          "using inlets or outlets as a targeting prescription during the spawn window",
        ],
      },
      {
        season: "late_fall",
        habitatClass:
          "Spawning overlap continues. Remaining lake fish that are not on the run stay pelagic.",
        conservationNote:
          "Spawning runs stay excluded from target guidance. This is not wild sea-run Atlantic salmon.",
        presentationImplication:
          "Reviewed families remain lawful feeding jobs away from the spawn window; they are not a redd method.",
        invalidators: [
          "collapsing landlocked salmon into federally endangered sea-run Atlantic salmon",
        ],
      },
    ],
    sources: [
