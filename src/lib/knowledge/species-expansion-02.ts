...
export const SPECIES_EXPANSION_02: SpeciesRecord[] = [
  {
    ...
    group: "bass_panfish",
    nativeContext: "Native to much of the Great Lakes, upper Mississippi, and Atlantic-slope region; widely moved beyond its native range.",
    ...
    habitat: {
      ...
      currentPreference: "Favors absent to sluggish current and uses protected margins, vegetation, wood, and other littoral cover.",
      depthTendency: "Mostly shallow to mid-depth around vegetation and cover; deeper edges become more useful under bright light or seasonal cooling.",
      lightResponse: "Primarily a daylight feeder, but shade and broken light concentrate use of cover on bright days.",
    },
    forageClasses: ["aquatic_insects", "mollusks", "crustaceans", "zooplankton", "small_forage_fish"],
    ...
    geographic: "Northern and eastern North America, especially vegetated lakes, ponds, reservoirs, and sluggish river margins.",
    sources: [
  ...
  },
  {
    ...
    group: "bass_panfish",
    nativeContext: "Native to the southeastern and south-central United States; widely stocked in warm ponds, lakes, and reservoirs.",
    ...
    habitat: {
      ...
      currentPreference: "Prefers still water or protected overflow pools and bays; avoids sustained main-channel current.",
      depthTendency: "Often uses slightly deeper littoral water than bluegill and feeds near bottom around vegetation, sand, mud, and shell-bearing substrate.",
      lightResponse: "Mostly active in daylight; bright clear conditions can shift fish deeper while preserving bottom and cover association.",
    },
  ...
  },
  {
    ...
    group: "bass_panfish",
    nativeContext: "Native across a broad central North American range and widely introduced; notably tolerant of turbidity, silt, and variable habitat.",
    ...
    habitat: {
      ...
      currentPreference: "More stream-tolerant than many Lepomis but still favors pools, margins, cover, and reduced velocity over a fast current core.",
      depthTendency: "Usually shallow to mid-depth and strongly structure-oriented; larger fish use deeper cover when pressure or light increases.",
      lightResponse: "Daylight feeder that uses shade, cover, and turbidity to reduce exposure.",
    },
    forageClasses: ["aquatic_insects", "terrestrial_insects", "crustaceans", "small_forage_fish", "mollusks"],
    ...
    geographic: "Central North America plus widespread introductions; streams, ponds, lakes, marshes, and disturbed warmwater habitat.",
    sources: [
  ...
  },
  {
    ...
    group: "bass_panfish",
    nativeContext: "Native to Great Lakes, St. Lawrence, Ohio, and Mississippi-basin waters; commonly associated with clear rocky streams and lake shorelines.",
    ...
    habitat: {
      ...
      currentPreference: "Uses permanent-flow streams but typically holds around rock, wood, pool structure, and velocity relief rather than the fastest lane.",
      depthTendency: "Shallow to mid-depth around rock and cover, moving deeper with high sun, pressure, or seasonal cooling.",
      lightResponse: "Often feeds most actively in early morning and evening; shade and rock cover remain useful through the day.",
    },
    forageClasses: ["crustaceans", "aquatic_insects", "small_forage_fish", "mollusks"],
    flowingPresentations: ["cross_current_retrieve", "pulse_jig", "bottom_contact_drift", "stationary_bait"],
    stillPresentations: ["bottom_contact", "stop_and_go", "drop_presentation", "horizontal_retrieve"],
    exceptions: [
    ...
    geographic: "Clear rocky rivers, streams, lake shores, and reservoirs of the Great Lakes and interior East/Central regions.",
    sources: [
  ...
  },
  {
    ...
    group: "predator",
    nativeContext: "Eastern North American esocid of vegetated lakes, swamps, backwaters, and sluggish streams; introduced in some inland basins.",
    ...
    habitat: {
      ...
      currentPreference: "Ambushes from vegetation and slack-water cover; sustained main-channel current is not the default feeding position.",
      depthTendency: "Primarily shallow to mid-depth around weeds and cover, with deeper edge use during bright or warm periods.",
      lightResponse: "Sight-oriented ambush predator; low light and stained water can increase use of open edges while bright conditions reinforce cover.",
    },
    ...
    sources: [
      ...
      { label: "South Carolina Department of Natural Resources chain pickerel account", class: SRC.agency },
    ],
    reviewedAt: "2026-08-27",
    nextReviewAt: "2026-11-27",
  },
  {
    ...
    commonNames: ["Bowfin"],
    group: "predator",
    nativeContext: "Ancient native predator of eastern North American low-gradient rivers, floodplains, swamps, backwaters, lakes, and bayous.",
    ...
    habitat: {
      ...
      currentPreference: "Strong fit is slack, backwater, and low-gradient habitat with vegetation or wood; not a sustained-current specialist.",
      depthTendency: "Often deeper or more covered by day, then moves shallower along weed and wood edges at night.",
      lightResponse: "Low light and night favor shallower feeding; daylight commonly reinforces depth and cover.",
    },
    forageClasses: ["small_forage_fish", "larger_prey_fish", "crustaceans", "amphibians", "aquatic_insects"],
    flowingPresentations: ["stationary_bait", "cross_current_retrieve", "pulse_jig"],
    stillPresentations: ["stop_and_go", "bottom_contact", "subsurface_slow_roll", "live_natural_bait_suspension"],
    exceptions: [
    ...
    geographic: "Eastern North America from the Great Lakes region to Gulf drainages in slow rivers, backwaters, swamps, lakes, and bayous.",
    sources: [
  ...
  },
  {
    ...
    group: "predator",
    nativeContext: "Native widespread gar of large rivers, reservoirs, lakes, backwaters, and connected low-gradient freshwater systems.",
    ...
    habitat: {
      ...
      currentPreference: "Uses large-river current margins and backwaters but often patrols slow or open water rather than holding tightly to one piece of cover.",
      depthTendency: "Adults can occupy deep water while making shallow or surface-oriented foraging movements; juveniles are more vegetation-associated.",
      lightResponse: "Visual predator that can feed through daylight; warm calm periods often produce visible near-surface cruising without implying a feeding event.",
    },
    ...
    stillPresentations: ["horizontal_retrieve", "stop_and_go", "live_natural_bait_suspension", "surface_retrieve"],
    exceptions: [
    ...
    geographic: "Large rivers, reservoirs, lakes, and backwaters across much of eastern and central North America.",
    sources: [
  ...
  },
  {
    ...
    group: "predator",
    nativeContext: "Native primarily to Mississippi and Gulf drainages, with limited Great Lakes occurrence; strongly associated with vegetated low-gradient water.",
    ...
    habitat: {
      ...
      currentPreference: "Strongly favors slow pools, backwaters, swamps, sloughs, and vegetated margins rather than fast current.",
      depthTendency: "Often shallow to mid-depth around vegetation and timber, with surface excursions for air that are not necessarily feeding.",
      lightResponse: "Visual ambush feeding can occur through daylight; vegetation and stain reduce exposure and define approach lanes.",
    },
    ...
    geographic: "Low-gradient rivers, lakes, swamps, sloughs, and vegetated backwaters of the central and southern United States.",
    sources: [
  ...
  },
  {
    ...
    group: "other",
    nativeContext: "Native to much of eastern North America and widely introduced; tolerant warmwater bottom feeder of ponds, lakes, reservoirs, and slow rivers.",
    ...
    habitat: {
      ...
      currentPreference: "Prefers little to moderate current and soft-bottomed protected water rather than fast river lanes.",
      depthTendency: "Bottom-oriented, using deeper water or cover by day and moving shallower under darkness or stain.",
      lightResponse: "Strong low-light and night feeding tendency; scent and bottom contact often matter more than visual range.",
    },
    forageClasses: ["worms_annelids", "aquatic_insects", "crustaceans", "mollusks", "small_forage_fish"],
    flowingPresentations: ["stationary_bait", "bottom_contact_drift", "pulse_jig"],
    ...
    geographic: "Ponds, lakes, reservoirs, oxbows, and slow rivers across eastern/central North America and introduced western waters.",
    sources: [
      { label: "USGS Nonindigenous Aquatic Species brown bullhead profile", class: SRC.agency },
      { label: "EPA freshwater fish temperature criteria synthesis for brown bullhead", class: SRC.agency },
    ],
    reviewedAt: "2026-08-27",
    nextReviewAt: "2026-11-27",
  },
  {
    ...
    group: "other",
    nativeContext: "Native central North American bullhead with broad introductions; especially tolerant of warm, turbid, low-gradient water.",
    ...
    habitat: {
      ...
      currentPreference: "Strong fit is slow, turbid, soft-bottomed water with little current; highly tolerant of conditions that exclude many sight-oriented fishes.",
      depthTendency: "Bottom-oriented, often shallow at night and deeper or tighter to cover in bright conditions.",
      lightResponse: "Low-light and nocturnal feeding is common; olfaction reduces dependence on visibility.",
    },
    forageClasses: ["worms_annelids", "aquatic_insects", "crustaceans", "mollusks", "small_forage_fish"],
    ...
    geographic: "Warm ponds, lakes, reservoirs, backwaters, and sluggish rivers across the central continent and introduced ranges.",
    sources: [
      { label: "Washington Department of Fish and Wildlife black bullhead sportfish account", class: SRC.agency },
  ...
  },
  {
    ...
    group: "trout_salmon",
    nativeContext: "Native pelagic coregonid of the Great Lakes and northern inland lakes; a major forage species with recreational value in some regions.",
    ...
    habitat: {
      ...
      currentPreference: "Pelagic lake fish whose position follows temperature, oxygen, plankton, prey fields, and basin circulation rather than cover.",
      depthTendency: "Highly depth-variable by season, time of day, and life stage; often suspended and capable of broad diel vertical movement.",
      lightResponse: "Light and plankton movement can shift schools vertically; bright conditions commonly reinforce deeper usable layers in clear water.",
    },
    ...
    geographic: "Great Lakes and cool northern inland lakes with adequate oxygenated coldwater habitat.",
    sources: [
  ...
  },
  {
    ...
    group: "other",
    nativeContext: "Native to Atlantic coastal drainages and landlocked in some northern lakes; introduced through much of the Great Lakes and other inland systems.",
    ...
    habitat: {
      ...
      currentPreference: "Reviewed here as a lake / reservoir pelagic fish; spawning runs are intentionally not modeled as flowing-water targets.",
      depthTendency: "Adults use cool pelagic water and can make strong diel vertical movements; seasonal depth may range from nearshore to very deep basins.",
      lightResponse: "Low light often permits higher positioning while clear bright conditions favor deeper pelagic layers.",
    },
    ...
    geographic: "Atlantic coastal waters and northern inland lakes, including introduced Great Lakes populations and other coldwater systems.",
    sources: [
  ...
  },
  {
    ...
    group: "other",
    nativeContext: "Atlantic-slope euryhaline species that also supports established landlocked freshwater populations, including Great Lakes and inland reservoirs.",
    ...
    habitat: {
      ...
      currentPreference: "Uses moderate river current during seasonal movement but otherwise behaves as a schooling open-water or basin-edge fish.",
      depthTendency: "Often deeper by day and seasonally offshore, with shallower movement around forage, wind, low light, and spawning migrations.",
      lightResponse: "Schooling feed can move shallower under low light or wind; bright clear conditions commonly favor depth.",
    },
    ...
    geographic: "Atlantic coastal rivers and estuaries plus landlocked freshwater populations in the Great Lakes and other inland systems.",
    sources: [
  ...
  },
  {
    ...
    group: "other",
    nativeContext: "Catadromous Atlantic-drainage fish that spends much of its growth phase in freshwater rivers, streams, lakes, and estuaries before migrating to sea to spawn.",
    ...
    habitat: {
      waterTypes: ["flowing", "stillwater"],
      riverHolding: ["deep_pool", "submerged_wood", "undercut_bank", "current_break", "side_channel"],
      stillHolding: ["wood", "basin", "drop_off", "weed_edge", "inlet"],
      currentPreference: "Smaller eels can use stronger current, while larger yellow eels more often occupy slower deep water, cover, soft bottom, and margins.",
      depthTendency: "Benthic and shelter-oriented by day; emerges from cover and may move shallower at night to feed.",
      lightResponse: "Strongly nocturnal; daylight usually favors snags, plants, burrows, tubes, depth, and other shelter.",
    },
    forageClasses: ["crustaceans", "aquatic_insects", "worms_annelids", "small_forage_fish", "mollusks", "amphibians"],
    flowingPresentations: ["stationary_bait", "bottom_contact_drift", "pulse_jig"],
    stillPresentations: ["bottom_contact", "slow_drag", "live_natural_bait_suspension"],
    exceptions: [
    ...
    geographic: "Atlantic and Gulf coastal drainages from Canada through the eastern United States, with freshwater residency extending far inland where passage remains connected.",
    sources: [
      { label: "U.S. Fish and Wildlife Service American eel species account", class: SRC.agency },
      { label: "USGS Nonindigenous Aquatic Species American eel ecology profile", class: SRC.agency },
  ...
  },
  {
    ...
    group: "other",
    nativeContext: "Anadromous Atlantic-coast clupeid with introduced Pacific populations; adults ascend freshwater rivers in spring to spawn.",
    ...
    habitat: {
      ...
      stillHolding: [],
      currentPreference: "Migratory adults travel through sustained river flow and pause in velocity transitions, current breaks, and staging water as conditions change.",
      depthTendency: "Often mid-column to lower during river migration, shifting with flow, temperature, turbidity, and daylight.",
      lightResponse: "Spawning activity is often strongest from dusk into darkness, but migration and angling encounters occur throughout the day depending on flow and turbidity.",
    },
    ...
    geographic: "Atlantic coastal rivers from Florida to Canada, with established introduced populations along the Pacific coast.",
    sources: [
      { label: "U.S. Fish and Wildlife Service American shad species account", class: SRC.agency },
      { label: "Atlantic-coast American shad management and life-history syntheses", class: SRC.syn },
    ],
    reviewedAt: "2026-08-27",
    nextReviewAt: "2026-11-27",
  },
