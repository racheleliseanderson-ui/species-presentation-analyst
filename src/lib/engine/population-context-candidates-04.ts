...
export const POPULATION_CONTEXT_CANDIDATES_04: PopulationContextCandidate[] = [
  {
    ...
    rationale:
      "Large Alaska/Pacific sockeye stocks support regulated fisheries and should not inherit the status of listed lower-48 ESUs.",
    constraints: [
      "Never infer fishery status from a water name.",
      "Returning freshwater adults are migration context, not a feeding claim.",
    ],
    sources: [{ label: "NOAA Fisheries Sockeye Salmon species profile", class: "agency" }],
  ...
  },
  {
    ...
    rationale:
      "Snake River sockeye are endangered and Ozette Lake sockeye are threatened under the ESA.",
    constraints: [
      "Context only — no presentation guidance when explicitly selected.",
      "No migration bottlenecks, spawning lakes/tributaries, or critical-habitat targeting.",
    ],
    sources: [{ label: "NOAA Fisheries Sockeye Salmon protected-ESU profile", class: "agency" }],
    reviewedAt: "2026-08-27",
    state: "reviewed_candidate",
  },
  {
    ...
    targetStatusEscalation: "regulated_context",
    rationale:
      "Pink salmon's two-year life cycle, rapid fry emigration, and non-feeding freshwater adult return are sufficiently distinctive to warrant explicit RPC context.",
    constraints: [
      "No odd/even-year abundance prediction from biology alone.",
      "No spawning reach or redd targeting.",
    ],
    sources: [
  ...
  },
  {
    ...
    targetStatusEscalation: "regulated_context",
    rationale:
      "Most chum fisheries require ordinary salmon regulation context while remaining biologically distinct from protected ESUs.",
    constraints: [
      "No population identity inference from geography alone.",
      "Freshwater migration mechanics are not a feeding claim.",
    ],
    sources: [{ label: "NOAA Fisheries Chum Salmon species profile", class: "agency" }],
    reviewedAt: "2026-08-27",
    state: "reviewed_candidate",
  },
  {
    ...
    constraints: [
      "Context only — no presentation guidance when explicitly selected.",
      "No critical-habitat, spawning, or migration-concentration guidance.",
    ],
    sources: [{ label: "NOAA Fisheries Chum Salmon protected-ESU profile", class: "agency" }],
    reviewedAt: "2026-08-27",
    state: "reviewed_candidate",
  },
  {
    ...
    rationale:
      "Lake pelagic smelt use and connected-stream drift/spawning habitat are materially different from wild sea-run Atlantic salmon.",
    constraints: [
      "Never resolve to the wild sea-run Atlantic salmon record.",
      "Spawning inlet/outlet runs remain invalidators.",
    ],
    sources: [
      {
        label:
  ...
  },
  {
    ...
    rationale:
      "ADF&G documents Alaska Arctic char as lake-resident and highly polymorphic among lakes, which should remain separate from anadromous char assumptions elsewhere in the circumpolar range.",
    constraints: [
      "Do not infer morph or diet from lake name.",
      "Numeric thermal limits remain species-level until population-specific review.",
    ],
    sources: [
  ...
  },
  {
    ...
    waterTypes: ["flowing", "stillwater"],
    rationale:
      "Resident headwater/river/lake fish behave differently from sea-run Dolly Varden and should not inherit estuarine migration assumptions.",
    constraints: [
      "Distinguish from Arctic char and bull trout by reviewed identification, not geography alone.",
    ],
    sources: [
  ...
  },
  {
    ...
    waterTypes: ["flowing", "stillwater"],
    rationale:
      "Sea-run fish use estuarine/coastal feeding and distinct overwintering/migration patterns compared with resident Dolly Varden.",
  ...
  },
  {
    ...
    targetStatusEscalation: "regulated_context",
    rationale:
      "Some sheefish travel more than 1,000 miles and use brackish overwintering areas before returning upriver to feed or spawn.",
    constraints: [
      "Discrete spawning areas are never target outputs.",
      "Do not infer migration destination from public water name.",
    ],
    sources: [
  ...
  },
  {
    ...
    targetStatusEscalation: "regulated_context",
    rationale:
      "ADF&G identifies resident fish that remain in freshwater rather than migrating to bays; they require a different movement frame.",
  ...
  },
  {
    ...
    targetStatusEscalation: "regulated_context",
    rationale:
      "Managed populations can support regulated fisheries but remain long-lived, late-maturing, and highly jurisdiction-dependent.",
    constraints: [
      "Current sturgeon rules always supersede biological plausibility.",
      "No spawning-reach guidance.",
    ],
    sources: [
  ...
  },
  {
    ...
    targetStatusEscalation: "conservation_sensitive",
    rationale:
      "The Kootenai River white sturgeon population is federally endangered and has severe recruitment constraints.",
    constraints: [
      "Context only — no presentation guidance when explicitly selected.",
      "No critical habitat, spawning reach, or migration-location output.",
    ],
    sources: [
      {
        label:
          "U.S. Fish and Wildlife Service Kootenai River White Sturgeon species/recovery profile",
        class: "agency",
      },
    ],
    reviewedAt: "2026-08-27",
  ...
  },
  {
    ...
    targetStatusEscalation: "regulated_context",
    rationale:
      "Large-river pools, backwaters, floodplain connectivity, long lifespan, and episodic recruitment materially shape alligator gar behavior and management.",
    constraints: [
      "Flooded spawning habitat is an invalidator, not a target map.",
      "Air-gulping never counts as surface-feeding evidence.",
    ],
    sources: [
