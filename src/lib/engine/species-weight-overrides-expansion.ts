...
export const SPECIES_OVERRIDE_EXPANSION_COVERAGE: SpeciesOverrideCoverageRecord[] = [
  {
    ...
    mode: "weighted",
    note: "Schooling interior temperate bass; current-run and pelagic reservoir mechanics are distinct.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "prosopium_williamsoni",
    mode: "weighted",
    note: "Benthic western whitefish with drift feeding and cold-season deep-water consolidation.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "thymallus_arcticus",
    mode: "weighted",
    note: "Drift- and insect-oriented coldwater salmonid with strong surface response when forage is observed.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ictalurus_furcatus",
    mode: "weighted",
    note: "Blue catfish separate river-bottom stationing from reservoir depth-band movement.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "pylodictis_olivaris",
    mode: "weighted",
    note: "Flathead catfish are cover-oriented and strongly piscivorous as adults.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "aplodinotus_grunniens",
    mode: "weighted",
    note: "Freshwater drum retain a strong benthic/mollusk identity.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepomis_gibbosus",
    mode: "weighted",
    note: "Pumpkinseed weighting preserves stronger mollusk/benthic use than generic sunfish logic.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepomis_microlophus",
    mode: "weighted",
    note: "Redear are especially bottom- and mollusk-oriented.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepomis_cyanellus",
    mode: "weighted",
    note: "Green sunfish tolerate streams and disturbed/turbid cover better than many Lepomis.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ambloplites_rupestris",
    mode: "weighted",
    note: "Rock bass weighting emphasizes rock, current relief, and crustacean/substrate mechanics.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "esox_niger",
    mode: "weighted",
    note: "Chain pickerel remain vegetation/slack-water ambush predators rather than open-pelagic esocids.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "amia_calva",
    mode: "weighted",
    note: "Bowfin weighting preserves cover, low-gradient water, and low-light movement without treating air-gulping as feeding.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepisosteus_osseus",
    mode: "weighted",
    note: "Longnose gar weighting separates mobile prey interception from respiratory surface rolling.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepisosteus_oculatus",
    mode: "weighted",
    note: "Spotted gar remain vegetation/backwater ambush predators.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ameiurus_nebulosus",
    mode: "weighted",
    note: "Brown bullhead retain nocturnal benthic/scent-oriented mechanics.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ameiurus_melas",
    mode: "weighted",
    note: "Black bullhead weighting emphasizes turbid, soft-bottomed, low-current feeding.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "coregonus_artedi",
    mode: "weighted",
    note: "Cisco are pelagic coldwater fish driven by plankton and depth bands.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "osmerus_mordax",
    mode: "weighted",
    note: "Rainbow smelt remain cold pelagic fish with diel vertical movement; spawning runs stay excluded.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "morone_americana",
    mode: "weighted",
    note: "White perch separate open-water schooling from seasonal river movement.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "anguilla_rostrata",
    mode: "weighted",
    note: "American eel remain nocturnal, benthic, shelter-oriented freshwater residents in this model.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "alosa_sapidissima",
    mode: "weighted",
    note: "American shad freshwater presentation is migration/interception context, not forage proof.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "salvelinus_confluentus",
    mode: "policy_only",
    note: "Conservation-sensitive context-only record; weighting remains intentionally unreachable.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "salmo_salar_anadromous",
    mode: "policy_only",
    note: "Protected wild anadromous U.S. Atlantic salmon record; presentation guidance remains disabled.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "acipenser_fulvescens",
    mode: "weighted",
    note: "Regulated-context lake sturgeon remain bottom-oriented, and rules vary sharply by jurisdiction.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "polyodon_spathula",
    mode: "policy_only",
    note: "Filter-feeding regulated-context record intentionally carries no capture-method weighting.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepomis_auritus",
    mode: "weighted",
    note: "Redbreast sunfish preserve stronger moving-water use than bluegill-like generic panfish logic.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepomis_gulosus",
    mode: "weighted",
    note: "Warmouth remain quiet-water cover ambush fish.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ameiurus_natalis",
    mode: "weighted",
    note: "Yellow bullhead preserve bottom-oriented low-light feeding in slow vegetated water.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepisosteus_platostomus",
    mode: "weighted",
    note: "Shortnose gar emphasize river/backwater prey interception and turbidity tolerance.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "morone_mississippiensis",
    mode: "weighted",
    note: "Yellow bass weighting preserves quieter-pool behavior alongside schooling open-water movement.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "morone_hybrid_wiper",
    mode: "weighted",
    note: "Wiper logic reflects stocked pelagic/current-oriented hybrid behavior without implying reproduction.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "hiodon_alosoides",
    mode: "weighted",
    note: "Goldeye preserve low-light/turbid upper-column feeding distinctions.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "hiodon_tergisus",
    mode: "weighted",
    note: "Mooneye preserve clear-water drift and surface feeding distinctions from goldeye.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ictiobus_cyprinellus",
    mode: "weighted",
    note: "Bigmouth buffalo can shift between plankton suspension and benthic feeding; regulated context remains visible.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ictiobus_bubalus",
    mode: "weighted",
    note: "Smallmouth buffalo remain strongly benthic rather than carp-like or plankton-first.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "moxostoma_macrolepidotum",
    mode: "weighted",
    note: "Shorthead redhorse weighting emphasizes clean-substrate current and benthic feeding outside spawning aggregations.",
    reviewedAt: "2026-08-27",
  },
];
...
export const SPECIES_WEIGHT_OVERRIDES_EXPANSION: SpeciesWeightOverrideRule[] = [
  rule(
    ...
    "morone_chrysops",
    {
      ...
      holding: ["suspended_open", "point", "drop_off"],
  ...
  rule(
    ...
    "prosopium_williamsoni",
    {
      thermalStates: ["cold_refuge", "active"],
      holding: ["deep_pool", "pool_tail", "basin", "drop_off"],
    },
  ...
  rule(
    ...
    "thymallus_arcticus",
    {
      seasons: ["summer", "late_summer"],
      forage: ["emerging_insects", "terrestrial_insects", "aquatic_insects"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["deep_pool", "run", "current_break", "tributary_mouth", "submerged_wood"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["stillwater"],
      holding: ["suspended_open", "basin", "drop_off"],
  ...
  rule(
    ...
    {
      stationary_bait: 10,
      live_natural_bait_suspension: 10,
      bottom_contact_drift: 5,
      slow_drag: 4,
    },
  ...
  rule(
    ...
    {
      forage: ["mollusks", "crustaceans"],
      holding: ["deep_pool", "pool_tail", "basin", "drop_off", "riprap", "point"],
    },
    {
  ...
  rule(
    ...
    {
      forage: ["mollusks", "crustaceans"],
      holding: ["weed_edge", "inside_weedline", "wood", "dock_shade", "shallow_flat"],
    },
    {
      slow_drag: 10,
      drop_presentation: 8,
  ...
  rule(
    ...
    {
      forage: ["mollusks"],
      holding: ["weed_edge", "outside_weedline", "drop_off", "shallow_flat"],
    },
    {
      bottom_contact: 12,
      slow_drag: 11,
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["eddy", "current_break", "submerged_wood", "deep_pool"],
      forage: ["aquatic_insects", "crustaceans", "small_forage_fish"],
    },
  ...
  rule(
    ...
    "esox_niger",
    {
      ...
      forage: ["small_forage_fish", "larger_prey_fish", "amphibians"],
    },
    {
      stop_and_go: 11,
  ...
  rule(
    ...
    "amia_calva",
    {
      light: ["low_light", "night"],
      holding: ["submerged_wood", "weed_edge", "inside_weedline", "wood", "side_channel", "inlet"],
    },
    {
      stop_and_go: 10,
      subsurface_slow_roll: 9,
  ...
  rule(
    ...
    {
      forage: ["small_forage_fish", "larger_prey_fish"],
      holding: ["run", "current_break", "shallow_flat", "point", "drop_off", "suspended_open"],
    },
    {
      cross_current_retrieve: 10,
      downstream_retrieve: 7,
  ...
  rule(
    ...
    "lepisosteus_oculatus",
    {
      ...
      forage: ["small_forage_fish", "crustaceans"],
    },
    {
      horizontal_retrieve: 9,
      stop_and_go: 10,
      live_natural_bait_suspension: 7,
      cross_current_retrieve: 7,
      pulse_jig: 4,
  ...
  rule(
    ...
    {
      light: ["low_light", "night"],
      holding: ["deep_pool", "wood", "weed_edge", "basin", "inlet", "submerged_wood"],
    },
    {
      stationary_bait: 10,
  ...
  rule(
    ...
    "coregonus_artedi",
    {
      forage: ["zooplankton", "crustaceans"],
      holding: ["suspended_open", "thermocline_edge", "basin"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["stillwater"],
      holding: ["suspended_open", "thermocline_edge", "basin", "drop_off"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["stillwater"],
      holding: ["basin", "drop_off", "point", "suspended_open"],
      forage: ["small_forage_fish", "zooplankton", "crustaceans"],
    },
  ...
  rule(
    ...
    "alosa_sapidissima",
    {
      ...
      holding: ["run", "pool_head", "current_break", "tributary_mouth", "tailwater"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["pool_tail", "run", "current_break", "boulder_pocket"],
      forage: ["aquatic_insects", "crustaceans"],
    },
  ...
  rule(
    ...
    "lepomis_gulosus",
    {
      ...
      forage: ["small_forage_fish", "crustaceans", "aquatic_insects"],
    },
    {
      pulse_jig: 8,
      cross_current_retrieve: 6,
      drop_presentation: 10,
      stop_and_go: 8,
      slow_drag: 5,
      surface_retrieve: 3,
    },
  ...
  rule(
    ...
    {
      holding: ["deep_pool", "eddy", "basin", "suspended_open", "drop_off", "point"],
      forage: ["small_forage_fish", "zooplankton"],
    },
    {
      cross_current_retrieve: 8,
      pulse_jig: 7,
      horizontal_retrieve: 10,
      vertical_jig: 9,
      stop_and_go: 7,
  ...
  rule(
    ...
    {
      waterTypes: ["stillwater"],
      holding: ["suspended_open", "point", "drop_off", "thermocline_edge"],
      forage: ["small_forage_fish"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["tailwater", "current_break", "run", "tributary_mouth", "deep_pool"],
    },
  ...
  rule(
    ...
    {
      light: ["low_light", "night"],
      forage: ["aquatic_insects", "emerging_insects", "terrestrial_insects"],
    },
    {
      surface_drift: 12,
      swing: 6,
  ...
  rule(
    ...
    {
      forage: ["small_forage_fish"],
      holding: ["run", "current_break", "pool_tail", "suspended_open", "drop_off"],
    },
  ...
  rule(
    ...
    "hiodon_tergisus",
    {
      waterTypes: ["flowing"],
      forage: ["aquatic_insects", "emerging_insects", "terrestrial_insects"],
      holding: ["run", "pool_tail", "current_break", "seam"],
    },
  ...
  rule(
    ...
    {
      forage: ["small_forage_fish"],
      holding: ["current_break", "deep_pool", "drop_off", "shallow_flat"],
    },
  ...
  rule(
    ...
    "ictiobus_cyprinellus",
    {
      waterTypes: ["stillwater"],
      forage: ["zooplankton"],
      holding: ["basin", "shallow_flat", "inlet", "drop_off"],
    },
  ...
  rule(
    ...
    "ictiobus_cyprinellus",
    {
      forage: ["aquatic_insects", "crustaceans", "worms_annelids"],
      holding: ["deep_pool", "eddy", "current_break", "weed_edge", "drop_off"],
    },
    {
      stationary_bait: 8,
      bottom_contact_drift: 9,
  ...
  rule(
    ...
    "ictiobus_bubalus",
    {
      forage: ["aquatic_insects", "crustaceans", "worms_annelids", "mollusks"],
      holding: ["deep_pool", "run", "current_break", "pool_tail", "drop_off", "basin", "point"],
    },
    {
      bottom_contact_drift: 11,
      stationary_bait: 8,
      bottom_contact: 11,
      slow_drag: 10,
  ...
  rule(
    ...
    {
      forage: ["aquatic_insects", "mollusks", "crustaceans", "worms_annelids"],
      holding: [
        "riffle_to_run",
        "run",
        "pool_tail",
