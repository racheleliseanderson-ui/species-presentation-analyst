...
export const SPECIES_WEIGHT_OVERRIDES: SpeciesWeightOverrideRule[] = [
  ...
  },
  {
    ...
    when: {
      ...
      holding: ["thermocline_edge", "drop_off", "inlet", "outlet"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["flowing"],
      holding: ["deep_pool", "current_break", "submerged_wood", "undercut_bank"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["flowing"],
      holding: ["undercut_bank", "side_channel", "submerged_wood", "deep_pool"],
    },
  ...
  },
  {
    ...
    when: {
      ...
      forage: ["emerging_insects", "terrestrial_insects"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["stillwater"],
      seasons: ["summer", "late_summer"],
      holding: ["thermocline_edge", "basin", "suspended_open", "drop_off"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["fall"],
      waterTypes: ["stillwater"],
      holding: ["rocky_shoreline", "submerged_hump", "drop_off"],
    },
  ...
  },
  {
    ...
    speciesId: "oncorhynchus_mykiss_steelhead",
    when: {
      thermalStates: ["preferred"],
      waterTypes: ["flowing"],
      holding: ["run", "seam", "pool_head", "tailwater"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["stillwater"],
      holding: ["thermocline_edge", "suspended_open", "drop_off"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["stillwater"],
      holding: ["thermocline_edge", "suspended_open", "point", "inlet"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["summer", "late_summer"],
      waterTypes: ["stillwater"],
      holding: ["weed_edge", "inside_weedline", "outside_weedline", "wood", "dock_shade"],
    },
    bias: {
      drop_presentation: 10,
      subsurface_slow_roll: 8,
      stop_and_go: 5,
      bottom_contact: 4,
      surface_retrieve: 3,
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["stillwater"],
      holding: ["shallow_flat", "weed_edge"],
  ...
  },
  {
    ...
    when: {
      ...
      holding: ["current_break", "seam", "run", "riffle_to_run", "pool_head"],
    },
    bias: {
  ...
  },
  {
    ...
    when: {
      seasons: ["winter", "late_fall"],
      waterTypes: ["stillwater"],
      holding: ["basin", "suspended_open", "wood"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["spring"],
      waterTypes: ["stillwater"],
      holding: ["wood", "dock_shade", "weed_edge", "inlet"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["summer", "late_summer"],
      waterTypes: ["stillwater"],
      holding: ["weed_edge", "inside_weedline", "dock_shade", "wood"],
    },
    bias: {
      drop_presentation: 8,
  ...
  },
  {
    ...
    speciesId: "lepomis_macrochirus",
    when: {
      forage: ["terrestrial_insects"],
      waterTypes: ["stillwater"],
      holding: ["weed_edge", "shallow_flat", "dock_shade"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["stillwater"],
      light: ["bright"],
      holding: ["drop_off", "breakline", "basin", "thermocline_edge"],
    },
  ...
  },
  {
    ...
    when: {
      light: ["low_light", "night"],
      holding: ["point", "rocky_shoreline", "inlet", "run", "current_break"],
    },
    bias: {
      trolling: 9,
      slow_drag: 5,
  ...
  },
  {
    ...
    when: {
      seasons: ["early_spring", "spring", "fall"],
      thermalStates: ["preferred", "active"],
      holding: ["weed_edge", "inside_weedline", "inlet", "side_channel", "eddy"],
    },
    bias: {
      stop_and_go: 8,
      horizontal_retrieve: 7,
  ...
  },
  {
    ...
    when: {
      seasons: ["summer", "late_summer"],
      waterTypes: ["stillwater"],
      holding: ["outside_weedline", "weed_edge", "point", "wood"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["stillwater"],
      holding: ["weed_edge", "outside_weedline", "point", "drop_off", "inlet", "wood"],
    },
  ...
  },
  {
    ...
    when: {
      waterTypes: ["flowing"],
      holding: ["deep_pool", "current_break", "tributary_mouth", "submerged_wood", "run"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["summer", "late_summer"],
      waterTypes: ["stillwater"],
      holding: ["shallow_flat", "weed_edge", "inlet"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["winter", "late_fall"],
      waterTypes: ["stillwater"],
      holding: ["basin", "drop_off", "submerged_hump"],
    },
  ...
  },
  {
    ...
    when: {
      seasons: ["winter", "late_fall"],
      holding: ["deep_pool", "basin", "drop_off", "submerged_hump", "rocky_shoreline"],
    },
    bias: {
      vertical_jig: 12,
      bottom_contact: 10,
  ...
  },
  {
    ...
    when: {
      waterTypes: ["flowing"],
      holding: ["deep_pool", "run", "tailwater", "current_break", "pool_head"],
    },
    bias: {
      bottom_contact_drift: 10,
      pulse_jig: 9,
