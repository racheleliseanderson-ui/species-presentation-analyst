...
export const SPECIES_OVERRIDE_EXPANSION_04_COVERAGE: SpeciesOverrideCoverageRecord[] = [
  {
    ...
    mode: "weighted",
    note: "Anadromous sockeye freshwater mechanics are migration/interception context, not a feeding claim.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "oncorhynchus_gorbuscha",
    mode: "weighted",
    note: "Returning pink salmon stop feeding; weighting is restricted to reviewed migration/interception mechanics.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "oncorhynchus_keta",
    mode: "weighted",
    note: "Chum salmon freshwater weighting reflects migration/current mechanics while population status remains regulation-gated.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "salmo_salar_landlocked",
    mode: "weighted",
    note: "Landlocked Atlantic salmon separate cold pelagic smelt pursuit from river insect/drift use.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "salvelinus_alpinus",
    mode: "weighted",
    note: "Arctic char weighting preserves cold-lake polymorphism: benthic/insect versus larger-fish piscivory.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "salvelinus_malma",
    mode: "weighted",
    note: "Dolly Varden weighting distinguishes resident drift feeding from mobile fish-prey behavior without targeting spawning aggregations.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "stenodus_leucichthys",
    mode: "weighted",
    note: "Adult sheefish are strongly piscivorous and can be either long-distance river migrants or resident lake/river predators.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "acipenser_transmontanus",
    mode: "weighted",
    note: "White sturgeon remain strongly benthic and jurisdiction/population gated.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "atractosteus_spatula",
    mode: "weighted",
    note: "Alligator gar weighting preserves low-gradient prey interception and rejects respiratory surface rolling as feeding evidence.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "catostomus_commersonii",
    mode: "weighted",
    note: "White sucker are adaptable but consistently benthic and avoid the fastest current core.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "catostomus_catostomus",
    mode: "weighted",
    note: "Longnose sucker retain colder, cleaner-substrate/current-oriented benthic mechanics.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "catostomus_macrocheilus",
    mode: "weighted",
    note: "Largescale sucker remain western substrate generalists in both river and lake settings.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "ameiurus_catus",
    mode: "weighted",
    note: "White catfish remain bottom-oriented but are less strictly nocturnal than bullheads.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "lepomis_megalotis",
    mode: "weighted",
    note: "Longear sunfish preserve stream-edge insect/crustacean behavior without inheriting strong-current logic.",
    reviewedAt: "2026-08-27",
  },
  {
    speciesId: "centrarchus_macropterus",
    mode: "weighted",
    note: "Flier weighting emphasizes vegetated low-current backwater rather than generic open-water sunfish mechanics.",
    reviewedAt: "2026-08-27",
  },
];
...
export const SPECIES_WEIGHT_OVERRIDES_EXPANSION_04: SpeciesWeightOverrideRule[] = [
  ...
  rule(
    ...
    "salmo_salar_landlocked",
    {
      ...
      holding: ["suspended_open", "thermocline_edge", "drop_off", "basin"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["stillwater"],
      forage: ["aquatic_insects", "emerging_insects", "zooplankton"],
      holding: ["rocky_shoreline", "inlet", "drop_off"],
    },
  ...
  rule(
    ...
    "salvelinus_alpinus",
    {
      ...
      holding: ["basin", "drop_off", "thermocline_edge"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      forage: ["aquatic_insects", "emerging_insects"],
      holding: ["run", "seam", "pool_head", "pool_tail"],
    },
  ...
  rule(
    ...
    "stenodus_leucichthys",
    {
      waterTypes: ["flowing"],
      forage: ["small_forage_fish", "larger_prey_fish"],
      holding: ["run", "deep_pool", "current_break", "pool_head", "pool_tail"],
    },
  ...
  rule(
    ...
    "stenodus_leucichthys",
    {
      waterTypes: ["stillwater"],
      forage: ["small_forage_fish", "larger_prey_fish"],
      holding: ["suspended_open", "drop_off", "basin", "inlet", "outlet"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["pool_tail", "current_break", "deep_pool", "side_channel"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["riffle_to_run", "run", "pool_tail", "current_break"],
      forage: ["aquatic_insects", "worms_annelids", "crustaceans"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["flowing"],
      holding: ["eddy", "side_channel", "current_break", "pool_tail", "submerged_wood"],
      forage: ["aquatic_insects", "terrestrial_insects", "crustaceans"],
    },
  ...
  rule(
    ...
    {
      waterTypes: ["stillwater"],
      holding: ["weed_edge", "shallow_flat", "rocky_shoreline", "wood", "inlet"],
    },
