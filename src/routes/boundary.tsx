    ...
    <div className="min-h-dvh bg-bg text-fg">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <p className="mt-5 text-base text-muted">
          Species & Presentation Analyst explains biological plausibility. It does not compete with catch-prediction products. The list below is an editorial stance we have chosen, not a shortcoming we plan to fix.
        </p>
